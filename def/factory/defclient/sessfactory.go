...
func getChannel(client fab.SystemClient, channelID string) (fab.Channel, error) {
...
func getEventHub(client fab.SystemClient, channelID string, session apisdk.Session) (*events.EventHub, error) {
