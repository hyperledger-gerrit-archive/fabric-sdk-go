...
func (f *SessionClientFactory) NewSystemClient(sdk apicontext.SDK, session apicontext.Session, config apiconfig.Config) (fab.FabricClient, error) {
...
func (f *SessionClientFactory) NewChannelMgmtClient(sdk apicontext.SDK, session apicontext.Session, config apiconfig.Config) (chmgmt.ChannelMgmtClient, error) {
...
func (f *SessionClientFactory) NewResourceMgmtClient(sdk apicontext.SDK, session apicontext.Session, config apiconfig.Config, filter resmgmt.TargetFilter) (resmgmt.ResourceMgmtClient, error) {
...
func (f *SessionClientFactory) NewChannelClient(sdk apicontext.SDK, session apicontext.Session, config apiconfig.Config, channelID string) (apitxn.ChannelClient, error) {
...
func getEventHub(client fab.FabricClient, channelID string, session apicontext.Session) (*events.EventHub, error) {
