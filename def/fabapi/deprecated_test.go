...
func TestNewChannelMgmtClient(t *testing.T) {
	...
	_, err = sdk.NewChannelMgmtClientWithOpts("Admin", &fabsdk.ChannelMgmtClientOpts{OrgName: "Invalid"})
	if err == nil {
	...
	_, err = sdk.NewChannelMgmtClientWithOpts("Admin", &fabsdk.ChannelMgmtClientOpts{OrgName: "ordererorg"})
	if err != nil {
...
func TestNewResourceMgmtClient(t *testing.T) {
	...
	_, err = sdk.NewResourceMgmtClientWithOpts("Admin", &fabsdk.ResourceMgmtClientOpts{OrgName: "Invalid"})
	if err == nil {
	...
	_, err = sdk.NewResourceMgmtClientWithOpts("Admin", &fabsdk.ResourceMgmtClientOpts{OrgName: "Org2"})
	if err != nil {
