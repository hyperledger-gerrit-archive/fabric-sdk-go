...
import (
	...
	ccpolicy "github.com/hyperledger/fabric-sdk-go/pkg/fabric-txn/ccpolicy/noopccpolicy"
...
// NewCCPolicyProvider returns a new default implementation of chaincode policy provider
func (f *DefaultProviderFactory) NewCCPolicyProvider(config apiconfig.Config) (fab.CCPolicyProvider, error) {
