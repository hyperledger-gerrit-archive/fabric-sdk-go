...
type Options struct {
	...
	CoreProviderFactory    context.CoreProviderFactory
	ServiceProviderFactory context.ServiceProviderFactory
...
func NewSDK(options Options) (*FabricSDK, error) {
	...
	if sdk.CoreProviderFactory == nil {
		sdk.CoreProviderFactory = defcore.NewDefaultProviderFactory()
	}
	if sdk.ServiceProviderFactory == nil {
		sdk.ServiceProviderFactory = defprovider.NewDefaultProviderFactory()
	}
	...
	config, err := sdk.CoreProviderFactory.NewConfigProvider(sdk.ConfigOpts, sdkOpts)
	if err != nil {
	...
	cryptosuite, err := sdk.CoreProviderFactory.NewCryptoSuiteProvider(sdk.configProvider)
	if err != nil {
	...
	store, err := sdk.CoreProviderFactory.NewStateStoreProvider(sdk.StateStoreOpts, sdk.configProvider)
	if err != nil {
	...
	signingMgr, err := sdk.CoreProviderFactory.NewSigningManager(sdk.CryptoSuiteProvider(), sdk.configProvider)
	if err != nil {
	...
	fabricProvider, err := sdk.CoreProviderFactory.NewFabricProvider(sdk.configProvider, sdk.stateStore, sdk.cryptoSuite, sdk.signingManager)
	if err != nil {
	...
	discoveryProvider, err := sdk.ServiceProviderFactory.NewDiscoveryProvider(sdk.configProvider)
	if err != nil {
	...
	selectionProvider, err := sdk.ServiceProviderFactory.NewSelectionProvider(sdk.configProvider)
	if err != nil {
...
func (sdk *FabricSDK) NewPreEnrolledUser(orgID string, userName string) (apifabclient.User, error) {
	...
	user, err := sdk.FabricProvider().NewPreEnrolledUser(userName, signingIdentity)
	if err != nil {
