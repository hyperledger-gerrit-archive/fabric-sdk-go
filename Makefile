...
THIRDPARTY_FABRIC_CA_COMMIT ?= 4b1f26c4f8914135f1e9439074bf414483245677
THIRDPARTY_FABRIC_BRANCH    ?= master
THIRDPARTY_FABRIC_COMMIT    ?= ab2e23e0fd868766f0eb4f54467336c5395a2bd3
...
DOCKER_COMPOSE_UP_FLAGS := -V --remove-orphans --force-recreate
...
DOCKER_COMPOSE_PULL_FLAGS := --include-deps
...
ifeq ($(FABRIC_SDK_DEPRECATED_UNITTEST),true)
	@GO_TAGS="$(GO_TAGS) deprecated" TEST_CHANGED_ONLY=true FABRIC_SDKGO_CODELEVEL_TAG=$(FABRIC_CODELEVEL_UNITTEST_TAG) FABRIC_SDKGO_CODELEVEL_VER=$(FABRIC_CODELEVEL_UNITTEST_VER) \
	$(TEST_SCRIPTS_PATH)/unit.sh
endif
