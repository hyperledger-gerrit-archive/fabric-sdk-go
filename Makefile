...
crypto-gen:
	...
	@$(DOCKER_CMD) run -i \
		-v $(abspath .):/opt/gopath/src/$(PACKAGE_NAME) -u $(shell id -u) \
	...
	ls -alh test/fixtures/fabric/$(FABRIC_CRYPTOCONFIG_VER)
	ls -alh test/fixtures/fabric/$(FABRIC_CRYPTOCONFIG_VER)/crypto-config
