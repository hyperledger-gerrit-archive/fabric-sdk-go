...
# Dockerenv options
FABRIC_DOCKERENV_BASE := -f docker-compose.yaml
FABRIC_DOCKERENV_SECONDPEER := -f docker-compose-secondpeer.yaml
FABRIC_DOCKERENV_COMPOSE_FILES := $(FABRIC_DOCKERENV_BASE)

FABRIC_DOCKERENV_TEST_PKCS11 := -f docker-compose-pkcs11-test.yaml
FABRIC_DOCKERENV_TEST_NOPKCS11 := -f docker-compose-nopkcs11-test.yaml
...
integration-tests-stable: clean depend populate
	@cd $(FIXTURE_DOCKERENV_PATH) && \
		FABRIC_SDKGO_CODELEVEL_VER=$(FABRIC_STABLE_CODELEVEL_VER) FABRIC_SDKGO_CODELEVEL_TAG=$(FABRIC_STABLE_CODELEVEL_TAG) FABRIC_DOCKER_REGISTRY=$(FABRIC_RELEASE_REGISTRY)/ $(DOCKER_COMPOSE_CMD) $(FABRIC_DOCKERENV_COMPOSE_FILES) $(FABRIC_DOCKERENV_TEST_NOPKCS11) up --force-recreate --abort-on-container-exit
	@cd $(FIXTURE_DOCKERENV_PATH) && FABRIC_DOCKER_REGISTRY=$(FABRIC_RELEASE_REGISTRY)/ $(FIXTURE_SCRIPTS_PATH)/check_status.sh "$(FABRIC_DOCKERENV_COMPOSE_FILES) $(FABRIC_DOCKERENV_TEST_NOPKCS11)"

.PHONY: integration-tests-prev
integration-tests-prev: clean depend populate
	@. $(FIXTURE_DOCKERENV_PATH)/prev-env.sh && \
		cd $(FIXTURE_DOCKERENV_PATH) && \
		FABRIC_SDKGO_CODELEVEL_VER=$(FABRIC_PREV_CODELEVEL_VER) FABRIC_SDKGO_CODELEVEL_TAG=$(FABRIC_PREV_CODELEVEL_TAG) FABRIC_DOCKER_REGISTRY=$(FABRIC_RELEASE_REGISTRY)/ $(DOCKER_COMPOSE_CMD) $(FABRIC_DOCKERENV_COMPOSE_FILES) $(FABRIC_DOCKERENV_TEST_NOPKCS11) up --force-recreate --abort-on-container-exit
	@cd $(FIXTURE_DOCKERENV_PATH) && FABRIC_DOCKER_REGISTRY=$(FABRIC_RELEASE_REGISTRY)/ $(FIXTURE_SCRIPTS_PATH)/check_status.sh "$(FABRIC_DOCKERENV_COMPOSE_FILES) $(FABRIC_DOCKERENV_TEST_NOPKCS11)"
...
integration-tests-prerelease: clean depend populate
	@. $(FIXTURE_DOCKERENV_PATH)/prerelease-env.sh && \
		cd $(FIXTURE_DOCKERENV_PATH) && \
		FABRIC_SDKGO_CODELEVEL_VER=$(FABRIC_PRERELEASE_CODELEVEL_VER) FABRIC_SDKGO_CODELEVEL_TAG=$(FABRIC_PRERELEASE_CODELEVEL_TAG) FABRIC_DOCKER_REGISTRY=$(FABRIC_RELEASE_REGISTRY)/ $(DOCKER_COMPOSE_CMD) $(FABRIC_DOCKERENV_COMPOSE_FILES) $(FABRIC_DOCKERENV_TEST_NOPKCS11) up --force-recreate --abort-on-container-exit
	@cd $(FIXTURE_DOCKERENV_PATH) && FABRIC_DOCKER_REGISTRY=$(FABRIC_RELEASE_REGISTRY)/ $(FIXTURE_SCRIPTS_PATH)/check_status.sh "$(FABRIC_DOCKERENV_COMPOSE_FILES) $(FABRIC_DOCKERENV_TEST_NOPKCS11)"
...
integration-tests-devstable: clean depend populate
	@. $(FIXTURE_DOCKERENV_PATH)/devstable-env.sh && \
		...
		cd $(FIXTURE_DOCKERENV_PATH) && \
		FABRIC_SDKGO_CODELEVEL_VER=$(FABRIC_DEVSTABLE_CODELEVEL_VER) FABRIC_SDKGO_CODELEVEL_TAG=$(FABRIC_DEVSTABLE_CODELEVEL_TAG) FABRIC_DOCKER_REGISTRY=$(FABRIC_DEV_REGISTRY)/ $(DOCKER_COMPOSE_CMD) $(FABRIC_DOCKERENV_COMPOSE_FILES) $(FABRIC_DOCKERENV_TEST_NOPKCS11) up --force-recreate --abort-on-container-exit
	@cd $(FIXTURE_DOCKERENV_PATH) && FABRIC_DOCKER_REGISTRY=$(FABRIC_DEV_REGISTRY)/ $(FIXTURE_SCRIPTS_PATH)/check_status.sh "$(FABRIC_DOCKERENV_COMPOSE_FILES) $(FABRIC_DOCKERENV_TEST_NOPKCS11)"

.PHONY: integration-tests-stable-pkcs11
integration-tests-stable-pkcs11: clean depend populate build-softhsm2-image
	@cd $(FIXTURE_DOCKERENV_PATH) && \
		FABRIC_SDKGO_CODELEVEL_VER=$(FABRIC_STABLE_CODELEVEL_VER) FABRIC_SDKGO_CODELEVEL_TAG=$(FABRIC_STABLE_CODELEVEL_TAG) FABRIC_DOCKER_REGISTRY=$(FABRIC_RELEASE_REGISTRY)/ $(DOCKER_COMPOSE_CMD) $(FABRIC_DOCKERENV_COMPOSE_FILES) $(FABRIC_DOCKERENV_TEST_PKCS11) up --force-recreate --abort-on-container-exit
	@cd $(FIXTURE_DOCKERENV_PATH) && FABRIC_DOCKER_REGISTRY=$(FABRIC_RELEASE_REGISTRY)/ $(FIXTURE_SCRIPTS_PATH)/check_status.sh "$(FABRIC_DOCKERENV_COMPOSE_FILES) $(FABRIC_DOCKERENV_TEST_PKCS11)"
...
dockerenv-prev-up: clean
	@cd $(FIXTURE_DOCKERENV_PATH) && \
		FABRIC_SDKGO_CODELEVEL_VER=$(FABRIC_PREV_CODELEVEL_VER) FABRIC_SDKGO_CODELEVEL_TAG=$(FABRIC_PREV_CODELEVEL_TAG) FABRIC_DOCKER_REGISTRY=$(FABRIC_RELEASE_REGISTRY)/ $(DOCKER_COMPOSE_CMD) $(FABRIC_DOCKERENV_COMPOSE_FILES) up --force-recreate

.PHONY: dockerenv-stable-up
dockerenv-stable-up: clean
	@cd $(FIXTURE_DOCKERENV_PATH) && \
		FABRIC_SDKGO_CODELEVEL_VER=$(FABRIC_STABLE_CODELEVEL_VER) FABRIC_SDKGO_CODELEVEL_TAG=$(FABRIC_STABLE_CODELEVEL_TAG) FABRIC_DOCKER_REGISTRY=$(FABRIC_RELEASE_REGISTRY)/ $(DOCKER_COMPOSE_CMD) $(FABRIC_DOCKERENV_COMPOSE_FILES) up --force-recreate

.PHONY: dockerenv-prerelease-up
dockerenv-prerelease-up: clean
	@cd $(FIXTURE_DOCKERENV_PATH) && \
		FABRIC_SDKGO_CODELEVEL_VER=$(FABRIC_PRERELEASE_CODELEVEL_VER) FABRIC_SDKGO_CODELEVEL_TAG=$(FABRIC_PRERELEASE_CODELEVEL_TAG) FABRIC_DOCKER_REGISTRY=$(FABRIC_RELEASE_REGISTRY)/ $(DOCKER_COMPOSE_CMD) $(FABRIC_DOCKERENV_COMPOSE_FILES) up --force-recreate
...
dockerenv-devstable-up: clean
	@. $(FIXTURE_DOCKERENV_PATH)/devstable-env.sh && \
		$(FABRIC_DEV_REGISTRY_PRE_CMD) && \
		cd $(FIXTURE_DOCKERENV_PATH) && \
		FABRIC_SDKGO_CODELEVEL_VER=$(FABRIC_DEVSTABLE_CODELEVEL_VER) FABRIC_SDKGO_CODELEVEL_TAG=$(FABRIC_DEVSTABLE_CODELEVEL_TAG) FABRIC_DOCKER_REGISTRY=$(FABRIC_DEV_REGISTRY)/ $(DOCKER_COMPOSE_CMD) $(FABRIC_DOCKERENV_COMPOSE_FILES) up --force-recreate
...
dockerenv-latest-up: clean
	@. $(FIXTURE_DOCKERENV_PATH)/devstable-env.sh && \
		...
		cd $(FIXTURE_DOCKERENV_PATH) && \
		FABRIC_SDKGO_CODELEVEL_VER=$(FABRIC_DEVSTABLE_CODELEVEL_VER) FABRIC_SDKGO_CODELEVEL_TAG=$(FABRIC_DEVSTABLE_CODELEVEL_TAG) FABRIC_DOCKER_REGISTRY="" $(DOCKER_COMPOSE_CMD) $(FABRIC_DOCKERENV_COMPOSE_FILES) up --force-recreate
