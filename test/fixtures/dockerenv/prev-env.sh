...
export FABRIC_CA_FIXTURE_TAG="${ARCH}-1.2.1"
export FABRIC_ORDERER_FIXTURE_TAG="${ARCH}-1.2.1"
export FABRIC_PEER_FIXTURE_TAG="${ARCH}-1.2.1"
export FABRIC_BUILDER_FIXTURE_TAG="${ARCH}-1.2.1"
