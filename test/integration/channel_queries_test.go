...
func TestChannelQueries(t *testing.T) {
	...
	testQueryByChaincode(t, channel)
...
func testQueryChannels(t *testing.T, channel api.Channel, client api.Client) {
...
func testInstalledChaincodes(t *testing.T, channel api.Channel, client api.Client) {
...
func testQueryByChaincode(t *testing.T, channel api.Channel) {
