...
func moveFundsAndGetTxID(setup *BaseSetupImpl) (string, error) {
	...
	transactionProposalResponse, txID, err := setup.CreateAndSendTransactionProposal(setup.Channel, setup.ChainCodeID, setup.ChannelID, args, []txnapi.ProposalProcessor{setup.Channel.PrimaryPeer()}, transientDataMap)
	if err != nil {
