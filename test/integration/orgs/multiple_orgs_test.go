...
func testWithOrg1(t *testing.T, sdk *fabsdk.FabricSDK) int {
	...
	org1ChannelClientContext := sdk.ChannelContext(fabsdk.WithChannelIdentityUser(org1User), fabsdk.WithChannelIdentityOrgName(org1), fabsdk.WithChannelID(channelID))
	org2ChannelClientContext := sdk.ChannelContext(fabsdk.WithChannelIdentityUser(org2User), fabsdk.WithChannelIdentityOrgName(org2), fabsdk.WithChannelID(channelID))
