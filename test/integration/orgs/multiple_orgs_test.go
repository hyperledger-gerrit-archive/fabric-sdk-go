...
func TestOrgsEndToEnd(t *testing.T) {
	...
	req := chmgmt.SaveChannelRequest{ChannelID: "orgchannel", ChannelConfig: path.Join("../../../", metadata.ChannelConfigPath, "orgchannel.tx"), SigningIdentity: []fab.IdentityContext{org1AdminUser}}
