...
func testWithOrg1(t *testing.T, sdk *fabsdk.FabricSDK) int {
	...
	if err = org1ResMgmt.JoinChannel("orgchannel", resmgmt.WithRetry(retry.DefaultResMgmtOpts), resmgmt.WithNetworkOrderer("orderer.example.com")); err != nil {
	...
	if err = org2ResMgmt.JoinChannel("orgchannel", resmgmt.WithRetry(retry.DefaultResMgmtOpts), resmgmt.WithNetworkOrderer("orderer.example.com")); err != nil {
...
func createChannel(org1AdminUser msp.SigningIdentity, org2AdminUser msp.SigningIdentity, chMgmtClient *resmgmt.Client, t *testing.T) {
	...
	txID, err := chMgmtClient.SaveChannel(req, resmgmt.WithRetry(retry.DefaultResMgmtOpts), resmgmt.WithNetworkOrderer("orderer.example.com"))
