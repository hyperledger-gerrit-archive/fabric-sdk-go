...
func testWithOrg1(t *testing.T, sdk *fabsdk.FabricSDK) int {
	...
	org1ClientContext := sdk.Context(fabsdk.WithUser(org1User), fabsdk.WithOrgName(org1))
	org1ChannelClientContext := fabsdk.ChannelContext(org1ClientContext, channelID)
	org2ClientContext := sdk.Context(fabsdk.WithUser(org2User), fabsdk.WithOrgName(org2))
	org2ChannelClientContext := fabsdk.ChannelContext(org2ClientContext, channelID)
