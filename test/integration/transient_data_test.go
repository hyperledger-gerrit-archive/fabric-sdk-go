...
func TestTransient(t *testing.T) {
	...
	transactionProposalResponse, _, err := testSetup.CreateAndSendTransactionProposal(testSetup.Channel, testSetup.ChainCodeID, testSetup.ChannelID, args, []txnapi.TxnProposalProcessor{testSetup.Channel.PrimaryPeer()}, transientDataMap)
	if err != nil {
