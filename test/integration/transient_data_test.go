...
func TestTransient(t *testing.T) {
	...
	transactionProposalResponse, _, err := util.CreateAndSendTransactionProposal(testSetup.Chain, testSetup.ChainCodeID, testSetup.ChainID, args, []api.Peer{testSetup.Chain.GetPrimaryPeer()}, transientDataMap)
	if err != nil {
