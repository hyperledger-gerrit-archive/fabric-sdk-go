...
func moveFunds(setup *BaseSetupImpl) error {
	...
	return fabricTxn.InvokeChaincode(setup.Client, setup.Channel, []txnapi.TxnProposalProcessor{setup.Channel.PrimaryPeer()}, setup.EventHub, setup.ChainCodeID, args, transientDataMap)
}
