...
func initializeLedgerTests(t *testing.T) (*fabsdk.FabricSDK, []string) {
	...
	req := resmgmt.SaveChannelRequest{ChannelID: channelID, ChannelConfigTxPath: integration.GetChannelConfigTxPath(channelConfigTxFile), SigningIdentities: []msp.SigningIdentity{adminIdentity}}
