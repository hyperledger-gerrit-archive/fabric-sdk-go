...
type setuOption func(*setupOptions) error

func WithConfigProvider(configProvider core.ConfigProvider) setuOption {
...
func setupClient(t *testing.T, opts ...setuOption) (*msp.Client, *fabsdk.FabricSDK) {
...
func TestCreateSDKWithoutCredentialStorePath(t *testing.T) {
	...
	// CA registrar should have been registered
