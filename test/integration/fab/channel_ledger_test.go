...
func initializeLedgerTests(t *testing.T) (*fabsdk.FabricSDK, []fab.Peer) {
	...
	req := resmgmt.SaveChannelRequest{ChannelID: channelID, ChannelConfig: channelConfig, SigningIdentity: adminSession}
...
func TestLedgerQueries(t *testing.T) {
	...
	channelClientCtx := fabsdk.ChannelContext(clientCtx, channelID)
