...
func initializeLedgerTests(t *testing.T) (*fabsdk.FabricSDK, []string) {
	...
	req := resmgmt.SaveChannelRequest{ChannelID: channelID, ChannelConfigFile: path.Join("../../../", metadata.ChannelConfigPath, channelConfigFile), SigningIdentities: []msp.Identity{adminIdentity}}
