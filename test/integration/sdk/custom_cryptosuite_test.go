...
func TestEndToEndForCustomCryptoSuite(t *testing.T) {
	...
	sdkOptions := fabapi.Options{
		...
		CoreProviderFactory: &CustomCryptoSuiteProviderFactory{bccspProvider: customBccspProvider},
	}
...
type CustomCryptoSuiteProviderFactory struct {
	defcore.DefaultProviderFactory
...
func TestCustomCryptoSuite(t *testing.T) {
	...
	sdkOptions := fabapi.Options{
		ConfigFile:          testSetup.ConfigFile,
		CoreProviderFactory: &CustomCryptoSuiteProviderFactory{bccspProvider: customBccspWrapper},
	}
