...
func TestChannelConfig(t *testing.T) {
	...
	reqCtx, cancel := context.NewRequest(channelCtx, context.WithTimeoutKey(core.PeerResponse))
	defer cancel()
...
func TestChannelConfigWithOrderer(t *testing.T) {
	...
	reqCtx, cancel := context.NewRequest(channelCtx, context.WithTimeoutKey(core.OrdererResponse))
	defer cancel()
