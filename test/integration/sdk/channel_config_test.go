...
func (f *CustomFabricProvider) CreateChannelConfig(ic context.IdentityContext, channelID string) (context.ChannelConfig, error) {
...
func (f *ChannelConfigFromOrdererProviderFactory) NewFabricProvider(context context.ProviderContext) (context.FabricProvider, error) {
