...
import (
	...
	packager "github.com/hyperledger/fabric-sdk-go/pkg/fabric-client/packager/gopackager"
...
func initializeTests(t *testing.T) BaseSetupImpl {
	...
	ccPkg, err := packager.PackageGoLangCC("github.com/events_cc", testSetup.GetDeployPath())
	if err != nil {
