...
func (setup *BaseSetupImpl) Initialize() error {
	...
	clientChannelContextProvider := sdk.ChannelContext(fabsdk.WithChannelIdentityUser(AdminUser), fabsdk.WithChannelIdentityOrgName(setup.OrgID), fabsdk.WithChannelID(setup.ChannelID))
