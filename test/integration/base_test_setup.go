...
func GetConfigOverridesPath(filename string) string {
	const configPath = "test/fixtures/config"
	return path.Join(metadata.GetProjectPath(), configPath, "overrides", filename)
}
