...
func (setup *BaseSetupImpl) RegisterTxEvent(txID string, eventHub event.EventHub) (chan bool, chan error) {
	done := make(chan bool)
...
func (setup *BaseSetupImpl) getEventHub(client fab.FabricClient) (event.EventHub, error) {
