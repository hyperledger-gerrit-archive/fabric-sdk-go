...
func (m *exampleSecurityProviderLibPath) SecurityProviderLibPath() string {
	return ""
	// below is an example implementation with real libraries path pulled from /test/fixtures/config/config_pkcs11_test.yaml
	// It is not used in this e2e configless test since it uses config_test.yaml
