...
func TestOrgsEndToEnd(t *testing.T) {
	...
	verifyMSPIDIsDiscovered(t)
}

//verifyMSPIDIsDiscovered uses new sdk instance with new config which only has entries for org1.
// this function tests if discovered peer has MSP ID found by dynamic discovery service.
func verifyMSPIDIsDiscovered(t *testing.T) {
