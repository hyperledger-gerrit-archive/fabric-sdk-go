...
cd ${PWD_ORIG}
openssl dgst -sha256 -sign ${KEY_PATH_DIR}/${KEY_NAME} -out ${SIGNATURE_PATH}/${CH_CFG}_${ORG_N}_${USER}_sbytes.txt.sha256 ${SIGNATURE_PATH}/${CH_CFG}_${ORG_N}_${USER}_sbytes.txt