...
func testDistributedSignatures(t *testing.T, examplecc string) {
	...
	org1MSPDsChannelCfgSig := createSignature(t, org1ClCtx, chConfigOrg1MSPPath, adminUser)
	...
	org2MSPDsChannelCfgSig := createSignature(t, org2ClCtx, chConfigOrg2MSPPath, adminUser)
