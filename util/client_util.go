...
import (
	...
	sdkUser "github.com/hyperledger/fabric-sdk-go/fabric-client/pkg/user"
...
func CreateAndSendTransactionProposal(chain api.Chain, chainCodeID string, chainID string, args []string, targets []api.Peer, transientData map[string][]byte) ([]*api.TransactionProposalResponse, string, error) {
...
func CreateAndSendTransaction(chain api.Chain, resps []*api.TransactionProposalResponse) ([]*api.TransactionResponse, error) {
...
func GetClient(name string, pwd string, stateStorePath string) (api.Client, error) {
