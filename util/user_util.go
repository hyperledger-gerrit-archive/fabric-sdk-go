...
// GetPreEnrolledUser ...
func GetPreEnrolledUser(c api.Client, keyDir string, certDir string, username string) (api.User, error) {
...
// GetMember ...
func GetMember(client api.Client, name string, pwd string) (api.User, error) {
