...
import (
	txn "github.com/hyperledger/fabric-sdk-go/api/txnapi"
...
type Channel interface {
	...
	SendInstantiateProposal(chaincodeName string, channelID string, args []string, chaincodePath string, chaincodeVersion string, targets []txn.TxnProposalProcessor) ([]*txn.TransactionProposalResponse, string, error)
	...
	QueryByChaincode(chaincodeName string, args []string, targets []txn.TxnProposalProcessor) ([][]byte, error)
}
