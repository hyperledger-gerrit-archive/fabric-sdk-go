...
func (m *MockFabricCAClient) Register(arg0 *apifabca.RegistrationRequest) (string, error) {
...
func (m *MockFabricCAClient) Revoke(arg0 *apifabca.RevocationRequest) (*apifabca.RevocationResponse, error) {
	ret := m.ctrl.Call(m, "Revoke", arg0)
	ret0, _ := ret[0].(*apifabca.RevocationResponse)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
