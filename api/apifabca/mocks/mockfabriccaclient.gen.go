...
func (m *MockFabricCAClient) Register(arg0 identity.User, arg1 *apifabca.RegistrationRequest) (string, error) {
...
func (m *MockFabricCAClient) Revoke(arg0 identity.User, arg1 *apifabca.RevocationRequest) (*api.RevocationResponse, error) {
