...
import (
	...
	factory "github.com/hyperledger/fabric-sdk-go/internal/fabric/bccsp/factory"
	reflect "reflect"
	time "time"
)
...
func (m *MockConfig) CAClientCertFile(arg0 string) (string, error) {
	ret := m.ctrl.Call(m, "CAClientCertFile", arg0)
	ret0, _ := ret[0].(string)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (mr *MockConfigMockRecorder) CAClientCertFile(arg0 interface{}) *gomock.Call {
...
func (m *MockConfig) CAServerCertFiles(arg0 string) ([]string, error) {
	ret := m.ctrl.Call(m, "CAServerCertFiles", arg0)
	ret0, _ := ret[0].([]string)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockConfig) TcertBatchSize() int {
	ret := m.ctrl.Call(m, "TcertBatchSize")
	ret0, _ := ret[0].(int)
	return ret0
}

// TcertBatchSize indicates an expected call of TcertBatchSize
func (mr *MockConfigMockRecorder) TcertBatchSize() *gomock.Call {
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "TcertBatchSize", reflect.TypeOf((*MockConfig)(nil).TcertBatchSize))
}
