...
type FabricClient interface {
	...
	InstallChaincode(chaincodeName string, chaincodePath string, chaincodeVersion string, chaincodePackage []byte, targets []Peer, ccType pb.ChaincodeSpec_Type) ([]*txn.TransactionProposalResponse, string, error)
