...
// Source: github.com/hyperledger/fabric-sdk-go/api/txn (interfaces: ProposalProcessor)
...
func (_m *MockProposalProcessor) ProcessTransactionProposal(_param0 txn.TransactionProposal) (txn.TransactionProposalResult, error) {
	ret := _m.ctrl.Call(_m, "ProcessTransactionProposal", _param0)
	ret0, _ := ret[0].(txn.TransactionProposalResult)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
