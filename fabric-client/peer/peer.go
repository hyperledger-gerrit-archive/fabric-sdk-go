 ...
 */
func (p *peer) IsEventListened(event string, chain api.Chain) (bool, error) {
	//to do
	return false, nil
}
 ...
 */
func NewPeer(url string, certificate string, serverHostOverride string) (api.Peer, error) {
