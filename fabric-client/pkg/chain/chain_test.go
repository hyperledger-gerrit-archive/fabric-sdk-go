...
import (
	...
	mocks "github.com/hyperledger/fabric-sdk-go/pkg/mocks"
...
func TestTargetPeers(t *testing.T) {
	...
	targetPeers, err := chain.getTargetPeers([]api.Peer{&invalidChoice})
	if err == nil {
	...
	targetPeers, err = chain.getTargetPeers([]api.Peer{&choice})
	if err != nil {
...
func TestConcurrentPeers(t *testing.T) {
	...
	result, err := chain.SendTransactionProposal(&api.TransactionProposal{
...
func TestJoinChannel(t *testing.T) {
	...
	chain, _ := setupTestChain()
	peer, _ := peer.NewPeer(testAddress, "", "")
...
func setupTestChain() (api.Chain, error) {
	client := mocks.NewMockClient()
...
func setupMassiveTestChain(numberOfPeers int, numberOfOrderers int) (api.Chain, error) {
