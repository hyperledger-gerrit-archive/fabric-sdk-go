 ...
 */
func NewChain(name string, client api.Client) (api.Chain, error) {
	if name == "" {
...
func (c *chain) QueryExtensionInterface() api.ChainExtension {
	return c
}

// GetClientContext returns the Client that was passed in to NewChain
func (c *chain) GetClientContext() api.Client {
	return c.clientContext
}

// GetProposalBytes returns the serialized transaction.
func (c *chain) GetProposalBytes(tp *api.TransactionProposal) ([]byte, error) {
 ...
 */
func (c *chain) AddPeer(peer api.Peer) error {
	url := peer.GetURL()
	if c.peers[url] != nil {
 ...
 */
func (c *chain) RemovePeer(peer api.Peer) {
	url := peer.GetURL()
	if c.peers[url] != nil {
		delete(c.peers, url)
 ...
 */
func (c *chain) GetPeers() []api.Peer {
...
func (c *chain) GetAnchorPeers() []api.OrgAnchorPeer {
 ...
 */
func (c *chain) getTargetPeers(targets []api.Peer) ([]api.Peer, error) {
 ...
 */
func (c *chain) isValidPeer(peer api.Peer) bool {
 ...
 */
func (c *chain) SetPrimaryPeer(peer api.Peer) error {
 ...
 */
func (c *chain) GetPrimaryPeer() api.Peer {
 ...
 */
func (c *chain) AddOrderer(orderer api.Orderer) error {
	url := orderer.GetURL()
 ...
 * @param {Orderer} orderer An instance of the Orderer class.
 */
func (c *chain) RemoveOrderer(orderer api.Orderer) {
	url := orderer.GetURL()
	if c.orderers[url] != nil {
 ...
 */
func (c *chain) GetOrderers() []api.Orderer {
 ...
 */
func (c *chain) GetGenesisBlock(request *api.GenesisBlockRequest) (*common.Block, error) {
 ...
 * @see /protos/peer/proposal_response.proto
 */
func (c *chain) JoinChannel(request *api.JoinChannelRequest) ([]*api.TransactionProposalResponse, error) {
 ...
 */
func (c *chain) queryByChaincodeByTarget(chaincodeName string, args []string, target api.Peer) ([]byte, error) {
 ...
 */
func QueryByChaincode(chaincodeName string, args []string, targets []api.Peer, clientContext api.Client) ([][]byte, error) {
	if chaincodeName == "" {
...
func (c *chain) QueryByChaincode(chaincodeName string, args []string, targets []api.Peer) ([][]byte, error) {
...
func CreateTransactionProposal(chaincodeName string, chainID string,
	args []string, sign bool, transientData map[string][]byte, clientContext api.Client) (*api.TransactionProposal, error) {
...
func (c *chain) SendTransactionProposal(proposal *api.TransactionProposal, retry int, targets []api.Peer) ([]*api.TransactionProposalResponse, error) {
 ...
 */
func (c *chain) CreateTransaction(resps []*api.TransactionProposalResponse) (*api.Transaction, error) {
	if len(resps) == 0 {
 ...
 */
func (c *chain) SendTransaction(tx *api.Transaction) ([]*api.TransactionResponse, error) {
...
func (c *chain) SignPayload(payload []byte) (*api.SignedEnvelope, error) {
	//Get user info
...
func (c *chain) BroadcastEnvelope(envelope *api.SignedEnvelope) ([]*api.TransactionResponse, error) {
...
func (c *chain) SendEnvelope(envelope *api.SignedEnvelope) (*common.Block, error) {
	if c.orderers == nil || len(c.orderers) == 0 {
		return nil, fmt.Errorf("orderers not set")
	}
