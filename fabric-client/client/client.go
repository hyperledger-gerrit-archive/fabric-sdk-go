...
import (
	...
	chain "github.com/hyperledger/fabric-sdk-go/fabric-client/pkg/chain"
	packager "github.com/hyperledger/fabric-sdk-go/fabric-client/pkg/packager"
	fcUser "github.com/hyperledger/fabric-sdk-go/fabric-client/pkg/user"
 ...
 */
func (c *client) NewChain(name string) (api.Chain, error) {
 ...
 */
func (c *client) GetChain(name string) api.Chain {
 ...
 */
func (c *client) QueryChainInfo(name string, peers []api.Peer) (api.Chain, error) {
...
func (c *client) CreateOrUpdateChannel(request *api.CreateChannelRequest, haveEnvelope bool) error {
	...
	if haveEnvelope {
		...
		channelHeader, err := chain.BuildChannelHeader(common.HeaderType_CONFIG_UPDATE, request.Name, request.TxID, 0, "", time.Now())
		if err != nil {
...
func (c *client) QueryChannels(peer api.Peer) (*pb.ChannelQueryResponse, error) {
	...
	responses, err := chain.QueryByChaincode("cscc", []string{"GetChannels"}, []api.Peer{peer}, c)
	if err != nil {
...
func (c *client) QueryInstalledChaincodes(peer api.Peer) (*pb.ChaincodeQueryResponse, error) {
	...
	responses, err := chain.QueryByChaincode("lscc", []string{"getinstalledchaincodes"}, []api.Peer{peer}, c)
	if err != nil {
...
func (c *client) InstallChaincode(chaincodeName string, chaincodePath string, chaincodeVersion string,
	...
	transactionProposalResponse, err := chain.SendTransactionProposal(&api.TransactionProposal{
