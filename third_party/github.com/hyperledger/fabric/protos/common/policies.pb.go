...
import fmt "fmt"
import math "math"
import common1 "github.com/hyperledger/fabric-sdk-go/third_party/github.com/hyperledger/fabric/protos/msp"
...
func init() {
	proto.RegisterType((*Policy)(nil), "commonclient.Policy")
	proto.RegisterType((*SignaturePolicyEnvelope)(nil), "commonclient.SignaturePolicyEnvelope")
	proto.RegisterType((*SignaturePolicy)(nil), "commonclient.SignaturePolicy")
	proto.RegisterType((*SignaturePolicy_NOutOf)(nil), "commonclient.SignaturePolicy.NOutOf")
	proto.RegisterType((*ImplicitMetaPolicy)(nil), "commonclient.ImplicitMetaPolicy")
	proto.RegisterEnum("commonclient.Policy_PolicyType", Policy_PolicyType_name, Policy_PolicyType_value)
	proto.RegisterEnum("commonclient.ImplicitMetaPolicy_Rule", ImplicitMetaPolicy_Rule_name, ImplicitMetaPolicy_Rule_value)
}
