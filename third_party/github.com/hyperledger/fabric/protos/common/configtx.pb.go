...
func init() {
	proto.RegisterType((*ConfigEnvelope)(nil), "sdk.sdk.common.ConfigEnvelope")
	proto.RegisterType((*ConfigGroupSchema)(nil), "sdk.sdk.common.ConfigGroupSchema")
	proto.RegisterMapType((map[string]*ConfigGroupSchema)(nil), "sdk.sdk.common.ConfigGroupSchema.GroupsEntry")
	proto.RegisterMapType((map[string]*ConfigPolicySchema)(nil), "sdk.sdk.common.ConfigGroupSchema.PoliciesEntry")
	proto.RegisterMapType((map[string]*ConfigValueSchema)(nil), "sdk.sdk.common.ConfigGroupSchema.ValuesEntry")
	proto.RegisterType((*ConfigValueSchema)(nil), "sdk.sdk.common.ConfigValueSchema")
	proto.RegisterType((*ConfigPolicySchema)(nil), "sdk.sdk.common.ConfigPolicySchema")
	proto.RegisterType((*Config)(nil), "sdk.sdk.common.Config")
	proto.RegisterType((*ConfigUpdateEnvelope)(nil), "sdk.sdk.common.ConfigUpdateEnvelope")
	proto.RegisterType((*ConfigUpdate)(nil), "sdk.sdk.common.ConfigUpdate")
	proto.RegisterMapType((map[string][]byte)(nil), "sdk.sdk.common.ConfigUpdate.IsolatedDataEntry")
	proto.RegisterType((*ConfigGroup)(nil), "sdk.sdk.common.ConfigGroup")
	proto.RegisterMapType((map[string]*ConfigGroup)(nil), "sdk.sdk.common.ConfigGroup.GroupsEntry")
	proto.RegisterMapType((map[string]*ConfigPolicy)(nil), "sdk.sdk.common.ConfigGroup.PoliciesEntry")
	proto.RegisterMapType((map[string]*ConfigValue)(nil), "sdk.sdk.common.ConfigGroup.ValuesEntry")
	proto.RegisterType((*ConfigValue)(nil), "sdk.sdk.common.ConfigValue")
	proto.RegisterType((*ConfigPolicy)(nil), "sdk.sdk.common.ConfigPolicy")
	proto.RegisterType((*ConfigSignature)(nil), "sdk.sdk.common.ConfigSignature")
}
