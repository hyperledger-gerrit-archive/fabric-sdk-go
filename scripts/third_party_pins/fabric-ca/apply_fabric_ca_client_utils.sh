...
FILTER_FN+=",getURL,StoreMyIdentity,NormalizeURL,initHTTPClient,net2LocalServerInfo,NewIdentity"
gofilter
...
FILTER_FN="GetDefaultBCCSP,InitBCCSP,ConfigureBCCSP,GetBCCSP,makeFileNamesAbsolute"
...
FILTER_FN="ReadFile,WriteFile,GenECDSAToken,B64Encode,B64Decode,HTTPRequestToString"
FILTER_FN+=",HTTPResponseToString,GetX509CertificateFromPEM,GetEnrollmentIDFromPEM"
FILTER_FN+=",GetSerialAsHex,MakeFileAbs,GetEnrollmentIDFromX509Certificate,Marshal"
FILTER_FN+=",Unmarshal,StructToString,FileExists,LoadX509KeyPair,CreateToken"
gofilter
