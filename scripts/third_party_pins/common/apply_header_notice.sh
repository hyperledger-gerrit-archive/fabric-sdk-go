...
FILES=($FILES)
NOTICE="Notice: This file has been modified for usage within Hyperledger fabric-sdk-go - please review third_party pinning scripts and patches for more details."
