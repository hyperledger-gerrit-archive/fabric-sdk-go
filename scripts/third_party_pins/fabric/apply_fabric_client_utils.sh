...
mv $TMP_PROJECT_PATH/internal $TMP_PROJECT_PATH/public
...
declare -a PKGS=(
    ...
    "public/configtxgen/encoder"
    "public/configtxgen/localconfig"
    "public/configtxlator/update"
...
declare -a FILES=(
    ...
    "public/configtxgen/encoder/encoder.go"
    "public/configtxgen/localconfig/config.go"
    "public/configtxlator/update/update.go"
    "public/configtxlator/update/update.go"

    "public/pkg/identity/identity.go"
...
FILTER_FILENAME="public/configtxgen/localconfig/config.go"
FILTER_FN=
gofilter
