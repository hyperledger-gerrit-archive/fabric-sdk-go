...
declare -a PKGS=(
        ...
        # TODO - refactor to remove this extra package.
        "core/chaincode/persistence/intf"
)
...
declare -a FILES=(
        ...
        # TODO - refactor to remove this extra file.
        "core/chaincode/persistence/intf/package_id.go"
)
