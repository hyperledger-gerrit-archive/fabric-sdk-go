...
func (cc *Client) createReqContext(txnOpts *opts) (reqContext.Context, reqContext.CancelFunc) {
...
func (cc *Client) prepareHandlerContexts(reqCtx reqContext.Context, request Request, o opts) (*invoke.RequestContext, *invoke.ClientContext, error) {
