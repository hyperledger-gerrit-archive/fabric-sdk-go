...
func New(c *context.ChannelClient) (*Client, error) {

	greylistProvider := greylist.New(c.Context.Config().TimeoutOrDefault(core.DiscoveryGreylistExpiry))
	...
	c.Discovery = discovery.NewDiscoveryFilterService(c.Discovery, greylistProvider)
