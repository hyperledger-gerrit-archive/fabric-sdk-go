...
func NewSignatureValidationHandler(next ...api.Handler) *SignatureValidationHandler {
...
func (f *SignatureValidationHandler) Handle(requestContext *api.RequestContext, clientContext *api.ClientContext) {
...
func (f *SignatureValidationHandler) validate(txProposalResponse []*context.TransactionProposalResponse, ctx *api.ClientContext) error {
...
func verifyProposalResponse(res *pb.ProposalResponse, ctx *api.ClientContext) error {
