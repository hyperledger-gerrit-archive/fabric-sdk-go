...
func (e *EndorsementHandler) Handle(requestContext *api.RequestContext, clientContext *api.ClientContext) {
...
func (h *ProposalProcessorHandler) Handle(requestContext *api.RequestContext, clientContext *api.ClientContext) {
...
func (f *EndorsementValidationHandler) Handle(requestContext *api.RequestContext, clientContext *api.ClientContext) {
...
func (f *EndorsementValidationHandler) validate(txProposalResponse []*context.TransactionProposalResponse) error {
	var a1 []byte
...
func (c *CommitTxHandler) Handle(requestContext *api.RequestContext, clientContext *api.ClientContext) {
...
func NewQueryHandler(next ...api.Handler) api.Handler {
...
func NewExecuteHandler(next ...api.Handler) api.Handler {
	return NewProposalProcessorHandler(
		NewEndorsementHandler(
			NewEndorsementValidationHandler(
...
func NewProposalProcessorHandler(next ...api.Handler) *ProposalProcessorHandler {
...
func NewEndorsementHandler(next ...api.Handler) *EndorsementHandler {
...
func NewEndorsementValidationHandler(next ...api.Handler) *EndorsementValidationHandler {
...
func NewCommitHandler(next ...api.Handler) *CommitTxHandler {
	return &CommitTxHandler{next: getNext(next)}
}

func getNext(next []api.Handler) api.Handler {
	if len(next) > 0 {
		return next[0]
	}
	return nil
...
func createAndSendTransaction(sender context.Sender, proposal *context.TransactionProposal, resps []*context.TransactionProposalResponse) (*context.TransactionResponse, error) {

	txnRequest := context.TransactionRequest{
		Proposal:          proposal,
...
func createAndSendTransactionProposal(sender context.ProposalSender, chrequest *api.Request, targets []context.ProposalProcessor) ([]*context.TransactionProposalResponse, *context.TransactionProposal, error) {
