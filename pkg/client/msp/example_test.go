...
func Example() {
	...
	if err != nil {
		fmt.Printf("Register return error %v\n", err)
		return
	}

	err = c.Enroll(username, WithSecret(enrollmentSecret))
	if err != nil {
		fmt.Printf("failed to enroll user: %v\n", err)
		return
	}
...
func ExampleClient_Reenroll() {
	...
	if err != nil {
		fmt.Printf("failed to reenroll user: %v\n", err)
		return
	}
...
func ExampleClient_Revoke() {
	...
	if err != nil {
		fmt.Printf("revoke return error %v\n", err)
	}
...
func ExampleWithCA() {
	...
	if err != nil {
		fmt.Printf("Get identities return error %v\n", err)
		return
	}
...
func ExampleClient_CreateIdentity() {
	...
	if err != nil {
		fmt.Printf("Create identity return error %v\n", err)
		return
	}
...
func ExampleClient_ModifyIdentity() {
	...
	if err != nil {
		fmt.Printf("Modify identity return error %v\n", err)
		return
	}
...
func ExampleClient_RemoveIdentity() {
	...
	if err != nil {
		fmt.Printf("Remove identity return error %v\n", err)
		return
	}
...
func ExampleClient_GetIdentity() {
	...
	if err != nil {
		fmt.Printf("Get identity return error %v\n", err)
		return
	}
