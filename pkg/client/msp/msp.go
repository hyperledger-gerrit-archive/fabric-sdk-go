...
// EnrollmmentOptions represent enrollment options
type EnrollmmentOptions struct {
	secret string
}

// EnrollmentOption describes a functional parameter for Enroll
type EnrollmentOption func(*EnrollmmentOptions) error

// WithSecret enrollment option
func WithSecret(secret string) EnrollmentOption {
	return func(o *EnrollmmentOptions) error {
		o.secret = secret
		return nil
	}
}
