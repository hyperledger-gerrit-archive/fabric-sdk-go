...
func TestInstallCCWithOpts(t *testing.T) {
	...
	req := InstallCCRequest{Name: "name", Version: "version", Path: "path", Package: &context.CCPackage{Type: 1, Code: []byte("code")}}
	...
	req = InstallCCRequest{Name: "ID", Version: "v0", Path: "path", Package: &context.CCPackage{Type: 1, Code: []byte("code")}}
	responses, err = rc.InstallCC(req, WithTargets(peers...))
	if err != nil {
		t.Fatal(err)
	}
	...
	req = InstallCCRequest{Name: "error", Version: "v0", Path: "path", Package: &context.CCPackage{Type: 1, Code: []byte("code")}}
...
func setupTestDiscovery(discErr error, peers []context.Peer) (context.DiscoveryProvider, error) {
