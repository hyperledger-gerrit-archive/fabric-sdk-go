...
var ordererOrg = &genesisconfig.Organization{
	...
	SkipAsForeign: false,
	ID:            "OrdererOrg",
	MSPDir:        filepath.Join(metadata.GetProjectPath(), "pkg/client/resmgmt/testdata/ordererorg/crypto-config/ordererOrganizations/example.com/msp"),
	MSPType:       "bccsp",
