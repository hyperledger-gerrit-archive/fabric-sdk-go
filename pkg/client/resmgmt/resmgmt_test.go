...
func TestSaveChannelSuccess(t *testing.T) {
	...
	_, err = cc.SaveChannel(SaveChannelRequest{ChannelID: "mychannel", ChannelConfig: r}, WithOrdererURL("example.com"))
	if err != nil {
		t.Fatal(err)
	}

	// Test valid Save Channel request (success / filename)
	_, err = cc.SaveChannel(SaveChannelRequest{ChannelID: "mychannel", ChannelConfigPath: channelConfig}, WithOrdererURL("example.com"))
	if err != nil {
		t.Fatal(err)
	}
}
...
func TestSaveChannelWithMultipleSigningIdenities(t *testing.T) {
	...
	_, err = cc.SaveChannel(req, WithOrdererURL(""))
	if err != nil {
