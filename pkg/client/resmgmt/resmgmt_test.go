...
func TestIsChaincodeInstalled(t *testing.T) {
	...
	peer1 := &fcmocks.MockPeer{MockName: "Peer1", MockURL: "grpc://peer1.com", MockRoles: []string{}, MockCert: nil, MockMSP: "Org1MSP", Status: 200, Payload: responseBytes}
...
func TestQueryInstalledChaincodes(t *testing.T) {
	...
	peer := &fcmocks.MockPeer{MockName: "Peer1", MockURL: "http://peer1.com", MockRoles: []string{}, MockCert: nil, MockMSP: "Org1MSP", Status: 200}
...
func TestQueryChannels(t *testing.T) {
	...
	peer := &fcmocks.MockPeer{MockName: "Peer1", MockURL: "http://peer1.com", MockRoles: []string{}, MockCert: nil, MockMSP: "Org1MSP", Status: 200, Payload: responseBytes}
...
func TestInstallCCWithOpts(t *testing.T) {
	...
	peer := fcmocks.MockPeer{MockName: "Peer1", MockURL: "http://peer1.com",
		Status: 200, MockRoles: []string{}, MockCert: nil, MockMSP: "Org1MSP", Payload: responseBytes}
