...
func TestJoinChannelWithOptsRequiredParameters(t *testing.T) {
	...
	// Test targets only
	err = rc.JoinChannel("mychannel", WithTargets(peers...), WithOrdererNameOrURL("orderer.example.com"))
	if err != nil {
		t.Fatalf(err.Error())
	}
...
func TestSaveChannelSuccess(t *testing.T) {
	...
	resp, err := cc.SaveChannel(SaveChannelRequest{ChannelID: "mychannel", ChannelConfig: r}, WithOrdererNameOrURL("example.com"))
	...
	resp, err = cc.SaveChannel(SaveChannelRequest{ChannelID: "mychannel", ChannelConfigPath: channelConfig}, WithOrdererNameOrURL("example.com"))
	assert.Nil(t, err, "error should be nil")
	assert.NotEmpty(t, resp.TransactionID, "transaction ID should be populated")
}
...
func TestSaveChannelWithOpts(t *testing.T) {
	...
	opts = WithOrdererNameOrURL("orderer.example.com")
	resp, err = cc.SaveChannel(req, opts)
	assert.Nil(t, err, "error should be nil")
	assert.NotEmpty(t, resp.TransactionID, "transaction ID should be populated")
	...
	opts = WithOrdererNameOrURL("Invalid")
...
func TestSaveChannelWithMultipleSigningIdenities(t *testing.T) {
	...
	resp, err = cc.SaveChannel(req, WithOrdererNameOrURL(""))
