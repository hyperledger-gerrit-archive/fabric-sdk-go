...
func Example() {
	...
	if err != nil {
		fmt.Printf("failed to open channel config: %v\n", err)
	}
	defer r.Close()
	...
	if err != nil {
		fmt.Printf("failed to save channel: %v\n", err)
	}
...
func ExampleClient_UpgradeCC() {
	...
	if err != nil {
		fmt.Printf("failed to upgrade chaincode: %v\n", err)
	}
...
func ExampleClient_QueryInstalledChaincodes() {
	...
	if err != nil {
		fmt.Printf("failed to query installed chaincodes: %v\n", err)
	}
...
func ExampleClient_QueryInstantiatedChaincodes() {
	...
	if err != nil {
		fmt.Printf("failed to query instantiated chaincodes: %v\n", err)
	}
