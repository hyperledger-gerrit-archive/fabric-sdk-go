...
func Example() {
	...
	_, err = c.SaveChannel(SaveChannelRequest{ChannelID: "mychannel", ChannelConfigTxReader: r})
	if err != nil {
...
func ExampleClient_SaveChannel() {
	...
	resp, err := c.SaveChannel(SaveChannelRequest{ChannelID: "mychannel", ChannelConfigTxReader: r})
	if err != nil {
		fmt.Printf("failed to save channel: %s\n", err)
	}
...
func ExampleClient_SaveChannel_withOrdererEndpoint() {
	...
	resp, err := c.SaveChannel(SaveChannelRequest{ChannelID: "mychannel", ChannelConfigTxReader: r}, WithOrdererEndpoint("example.com"))
	if err != nil {
		fmt.Printf("failed to save channel: %s\n", err)
	}
...
func ExampleClient_SaveChannel_updateChannelConfig() {
	...
	if err != nil {
		fmt.Printf("error modifying config block: %s\n", err)
	}

	resp, err := c.SaveChannel(SaveChannelRequest{ChannelID: "mychannel", ChannelConfig: channelConfig}, WithOrdererEndpoint("example.com"))
	if err != nil {
		fmt.Printf("failed to save channel: %s\n", err)
	}
