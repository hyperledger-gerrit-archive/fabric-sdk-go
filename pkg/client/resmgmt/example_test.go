...
func Example() {
	...
	_, err = c.SaveChannel(SaveChannelRequest{ChannelID: "mychannel", ChannelConfigTx: r})
	if err != nil {
...
func ExampleClient_SaveChannel() {
	...
	resp, err := c.SaveChannel(SaveChannelRequest{ChannelID: "mychannel", ChannelConfigTx: r})
	if err != nil {
		fmt.Printf("failed to save channel: %s\n", err)
	}
...
func ExampleClient_SaveChannel_withOrdererEndpoint() {
	...
	resp, err := c.SaveChannel(SaveChannelRequest{ChannelID: "mychannel", ChannelConfigTx: r}, WithOrdererEndpoint("example.com"))
	if err != nil {
		fmt.Printf("failed to save channel: %s\n", err)
	}
