...
// * CreateConfigSignatureExternal call with signingBytes used for creating a signature by external tool (ex: Openssl)
//
...
func WithConfigSignature(r io.Reader) RequestOption {
	return func(ctx context.Client, opts *requestOptions) error {
