...
import (
	...
	"github.com/hyperledger/fabric-sdk-go/internal/github.com/hyperledger/fabric/public/configtxgen/localconfig"
...
func (rc *Client) InspectGenesisBlock(block []byte) error {
