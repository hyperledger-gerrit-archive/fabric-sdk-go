...
type SaveChannelRequest struct {
	...
	ChannelConfigFile string         // Convenience option to use the file as ChannelConfig reader
...
func (rc *Client) SaveChannel(req SaveChannelRequest, options ...RequestOption) error {
	...
	if req.ChannelConfigFile != "" {
		configReader, err := os.Open(req.ChannelConfigFile)
		if err != nil {
