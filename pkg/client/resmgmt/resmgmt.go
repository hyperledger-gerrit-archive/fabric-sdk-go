...
type requestOptions struct {
	...
	Background   reqContext.Context                 //background grpc context for resmgmt operations
}
...
func (rc *Client) JoinChannel(channelID string, options ...RequestOption) error {
	...
	parentReqCtx, parentReqCancel := contextImpl.NewRequest(rc.ctx, contextImpl.WithTimeout(opts.Timeouts[core.ResMgmt]), contextImpl.WithReqContext(opts.Background))
	...
	peerReqCtx, peerReqCtxCancel := contextImpl.NewRequest(rc.ctx, contextImpl.WithTimeoutType(core.ResMgmt), contextImpl.WithReqContext(parentReqCtx))
...
func (rc *Client) InstallCC(req InstallCCRequest, options ...RequestOption) ([]InstallCCResponse, error) {
	...
	reqCtx, cancel := contextImpl.NewRequest(rc.ctx, contextImpl.WithTimeoutType(core.ResMgmt), contextImpl.WithReqContext(parentReqCtx))
	defer cancel()
...
func (rc *Client) createRequestContext(opts requestOptions, defaultTimeoutType core.TimeoutType) (reqContext.Context, reqContext.CancelFunc) {
	...
	return contextImpl.NewRequest(rc.ctx, contextImpl.WithTimeout(opts.Timeouts[defaultTimeoutType]), contextImpl.WithReqContext(opts.Background))
}
