...
// Provider implements a local Dynamic Discovery Provider that queries
...
// New creates a new local dynamic discovery provider
func New(config fab.EndpointConfig, opts ...coptions.Opt) *Provider {
	return &Provider{
