...
func NewPeerGroup(peers ...context.Peer) PeerGroup {
...
func (pg *peerGroup) Peers() []context.Peer {
	peers := make([]context.Peer, len(pg.peers))
...
func (pg *mspPeerGroup) Peers() []context.Peer {
...
func asPeerWrappers(peers []context.Peer) []*peerWrapper {
