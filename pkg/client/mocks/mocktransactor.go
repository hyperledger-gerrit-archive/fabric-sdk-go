...
func (t *MockTransactor) CreateTransactionID() (context.TransactionID, error) {
...
func (t *MockTransactor) CreateChaincodeInvokeProposal(request context.ChaincodeInvokeRequest) (*context.TransactionProposal, error) {
...
func (t *MockTransactor) SendTransactionProposal(proposal *context.TransactionProposal, targets []context.ProposalProcessor) ([]*context.TransactionProposalResponse, error) {
	return txn.SendProposal(t.Ctx, proposal, targets)
}

// CreateTransaction create a transaction with proposal response.
func (t *MockTransactor) CreateTransaction(request context.TransactionRequest) (*context.Transaction, error) {
...
func (t *MockTransactor) SendTransaction(tx *context.Transaction) (*context.TransactionResponse, error) {
