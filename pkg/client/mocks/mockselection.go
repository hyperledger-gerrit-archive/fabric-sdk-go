...
func NewMockSelectionProvider(err error, peers []context.Peer) (*MockSelectionProvider, error) {
...
func (ds *MockSelectionService) GetEndorsersForChaincode(channelPeers []context.Peer,
