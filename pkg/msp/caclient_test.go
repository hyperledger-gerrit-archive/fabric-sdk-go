...
func TestModifyAffiliation(t *testing.T) {
	...
	resp, err := f.caClient.ModifyAffiliation(&api.ModifyAffiliationRequest{NewName: "test1new.com", AffiliationRequest: api.AffiliationRequest{Name: "test1.com"}})
	if err != nil {
...
func TestRemoveAffiliation(t *testing.T) {
	...
	resp, err := f.caClient.RemoveAffiliation(&api.AffiliationRequest{Name: "test1.com"})
	if err != nil {
...
func TestGetAffiliation(t *testing.T) {
	...
	resp, err := f.caClient.GetAffiliation("test1.com", "")
	if err != nil {
