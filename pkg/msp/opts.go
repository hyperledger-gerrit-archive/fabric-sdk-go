...
// BuildConfigIdentityFromOptions will return an IdentityConfig instance pre-built with Optional interfaces
// provided in fabsdk's WithConfigIdentity(opts...) call
func BuildConfigIdentityFromOptions(opts ...interface{}) (msp.IdentityConfig, error) {
