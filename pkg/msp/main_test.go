...
const (
	...
	wrongURLConfigPath          = "testdata/config_test_wrong_url.yaml"
...
func (f *textFixture) setup(configPath string) {
	...
	if !httpServerRunning {
		...
		// Start Http Server
		go mocks.StartFabricCAMockServer(strings.TrimPrefix(caServerURL, "http://"), f.cryptoSuite)
