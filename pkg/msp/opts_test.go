...
func TestCreateCustomIdentityConfig(t *testing.T) {
	...
	// verify if an interface was not passed as an option but was not nil, it should be nil (ie these implementations should not populated in ico: m5, m6 and m7)
...
func TestCreateCustomIdentityConfigRemainingFunctions(t *testing.T) {
	...
	// verify if an interface was not passed as an option but was not nil, it should be nil (ie these implementations should not populated in ico: m1, m2, m3 and m4)
...
func TestCreateCustomIdentityConfigWithSomeDefaultFunctions(t *testing.T) {
	...
	// ie, verify these implementations should nil: m5, m6 and m7
	...
	// ie, verify these implementations should now populated in ico: m5, m6, m7
