...
func TestGetSigningIdentity(t *testing.T) {
	...
	cryptoConfig, endpointConfig, identityConfig, mspID, clientCofig := createConfigs(t)
...
func createConfigs(t *testing.T) (core.CryptoSuiteConfig, providersFab.EndpointConfig, msp.IdentityConfig, string, *msp.ClientConfig) {
	...
	return cryptoConfig, endpointConfig, identityConfig, mspID, clientCofig
}
