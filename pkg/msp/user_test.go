...
func TestUserMethods(t *testing.T) {
	...
	importBCCSPKeyFromPEMBytes(cryptoSuite, t, userData, testUserMSPID, testUsername)

}

func importBCCSPKeyFromPEMBytes(cryptoSuite core.CryptoSuite, t *testing.T, userData *msp.UserData, testUserMSPID string, testUsername string) {
