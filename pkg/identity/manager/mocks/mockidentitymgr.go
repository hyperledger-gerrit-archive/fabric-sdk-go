...
func NewMockIdentityManager(orgName string, cryptoProvider core.CryptoSuite, config core.Config) (idapi.IdentityManager, error) {
...
func (mgr *MockIdentityManager) Register(request *idapi.RegistrationRequest) (string, error) {
	return "", errors.New("not implemented")
}

// Revoke revokes a user
func (mgr *MockIdentityManager) Revoke(request *idapi.RevocationRequest) (*idapi.RevocationResponse, error) {
