...
func (c *Channel) QueryConfigBlock(peers []fab.Peer, minEndorsers int) (*common.ConfigEnvelope, error) {
	...
	if len(responses) < minEndorsers {
		return nil, errors.Errorf("Required minimum %d endorsments got %d", minEndorsers, len(responses))
	}
