...
func TestTransaction(t *testing.T) {
	...
	request := context.TransactionRequest{
		Proposal:          tp,
...
func createTransactor(t *testing.T) context.Transactor {
	...
	transactor.orderers = []context.Orderer{orderer}
	assert.Nil(t, err)

	return transactor
}

func createTxnID(t *testing.T, transactor context.Transactor) context.TransactionID {
...
func createTransactionProposal(t *testing.T, transactor context.Transactor) *context.TransactionProposal {
...
func createTransactionProposalResponse(t *testing.T, transactor context.Transactor, tp *context.TransactionProposal) []*context.TransactionProposalResponse {

	peer := mocks.MockPeer{MockName: "Peer1", MockURL: "http://peer1.com", MockRoles: []string{}, Status: 200}
	tpr, err := transactor.SendTransactionProposal(tp, []context.ProposalProcessor{&peer})
	assert.Nil(t, err)

	return tpr
}

func createTransactionProposalResponseBadStatus(t *testing.T, transactor context.Transactor, tp *context.TransactionProposal) []*context.TransactionProposalResponse {
