 ...
 */
func (c *channel) queryByChaincodeByTarget(chaincodeName string, args []string, target txnapi.TxnProposalProcessor) ([]byte, error) {

	queryResponses, err := c.QueryByChaincode(chaincodeName, args, []txnapi.TxnProposalProcessor{target})
	if err != nil {
 ...
 */
func QueryByChaincode(chaincodeName string, args []string, targets []txnapi.TxnProposalProcessor, clientContext api.FabricClient) ([][]byte, error) {
	if chaincodeName == "" {
...
func (c *channel) QueryByChaincode(chaincodeName string, args []string, targets []txnapi.TxnProposalProcessor) ([][]byte, error) {
...
func (c *channel) SendTransactionProposal(proposal *txnapi.TransactionProposal, retry int, targets []txnapi.TxnProposalProcessor) ([]*txnapi.TransactionProposalResponse, error) {
...
//SendTransactionProposal ...
func SendTransactionProposal(proposal *txnapi.TransactionProposal, retry int, targets []txnapi.TxnProposalProcessor) ([]*txnapi.TransactionProposalResponse, error) {
...
func (c *channel) SendInstantiateProposal(chaincodeName string, channelID string,
	args []string, chaincodePath string, chaincodeVersion string, targets []txnapi.TxnProposalProcessor) ([]*txnapi.TransactionProposalResponse, string, error) {
