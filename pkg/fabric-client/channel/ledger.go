...
func queryChaincode(ctx fab.Context, channel string, request fab.ChaincodeInvokeProposal, targets []fab.ProposalProcessor) ([]*fab.TransactionProposalResponse, error) {
