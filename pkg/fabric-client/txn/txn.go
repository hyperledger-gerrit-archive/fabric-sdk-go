...
// broadcastEnvelope will send the given payload to some orderer, picking random endpoints
// until all are exhausted
...
// SendPayload sends the given envelope to each orderer and returns a block response
