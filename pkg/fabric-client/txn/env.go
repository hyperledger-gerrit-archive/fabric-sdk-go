...
//
// TODO: Determine if this function should be exported after refactoring is completed.
func CreateChannelHeader(headerType common.HeaderType, channelID string, txID string, epoch uint64, chaincodeID string, timestamp time.Time, tlsCertHash []byte) (*common.ChannelHeader, error) {
...
func CreateHeader(creator []byte, channelHeader *common.ChannelHeader, nonce []byte) (*common.Header, error) {
