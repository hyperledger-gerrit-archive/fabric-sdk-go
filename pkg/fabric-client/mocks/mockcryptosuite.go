...
//func (m *MockCryptoSuite) KeyDeriv(k apicryptosuite.Key,
//	opts apicryptosuite.KeyDerivOpts) (dk apicryptosuite.Key, err error) {
//	return nil, nil
//}
...
//// Verify mock verify
//func (m *MockCryptoSuite) Verify(k apicryptosuite.Key, signature, digest []byte,
//	opts apicryptosuite.SignerOpts) (valid bool, err error) {
//	return false, nil
//}
//
//// Encrypt mock encrypt
//func (m *MockCryptoSuite) Encrypt(k apicryptosuite.Key, plaintext []byte,
//	opts apicryptosuite.EncrypterOpts) (ciphertext []byte, err error) {
//	return nil, nil
//}
//
//// Decrypt mock decrypt
//func (m *MockCryptoSuite) Decrypt(k apicryptosuite.Key, ciphertext []byte,
//	opts apicryptosuite.DecrypterOpts) (plaintext []byte, err error) {
//	return nil, nil
//}
