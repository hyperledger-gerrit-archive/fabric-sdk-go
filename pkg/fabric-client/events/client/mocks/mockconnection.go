...
func (cp *ProviderFactory) Provider(conn Connection) connection.Provider {
	return func(string, apifabclient.Context, apifabclient.Peer) (connection.Connection, error) {
		return conn, nil
	}
}
...
func (cp *ProviderFactory) FlakeyProvider(connAttemptResults ConnectAttemptResults, opts ...Opt) connection.Provider {
