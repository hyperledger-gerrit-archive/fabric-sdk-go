...
import (
	...
	"github.com/hyperledger/fabric-sdk-go/pkg/fabric-client/events/api"
...
type ClientProvider func(channelID string, context apifabclient.Context, connectionProvider api.ConnectionProvider, discoveryService apifabclient.DiscoveryService, opts []options.Opt) (*Client, error)

var clientProvider = func(channelID string, context apifabclient.Context, connectionProvider api.ConnectionProvider, discoveryService apifabclient.DiscoveryService, opts []options.Opt) (*Client, error) {
...
var failAfterConnectClientProvider = func(channelID string, context apifabclient.Context, connectionProvider api.ConnectionProvider, discoveryService apifabclient.DiscoveryService, opts []options.Opt) (*Client, error) {
	return newClient(channelID, context, connectionProvider, discoveryService, opts, true,
		func() error {
...
var filteredClientProvider = func(channelID string, context apifabclient.Context, connectionProvider api.ConnectionProvider, discoveryService apifabclient.DiscoveryService, opts []options.Opt) (*Client, error) {
...
func newClient(channelID string, context apifabclient.Context, connectionProvider api.ConnectionProvider, discoveryService apifabclient.DiscoveryService, opts []options.Opt, permitBlockEvents bool, afterConnect handler, beforeReconnect handler) (*Client, error) {
	client := New(
		permitBlockEvents,
		dispatcher.New(
			channelID, context,
...
func newClientWithMockConnAndOpts(channelID string, context apifabclient.Context, connectionProvider api.ConnectionProvider, clientProvider ClientProvider, discoveryService apifabclient.DiscoveryService, opts []options.Opt, connOpts ...mockconn.Opt) (*Client, mockconn.Connection, error) {
