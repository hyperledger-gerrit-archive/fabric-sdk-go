...
func NewRegisterConnectionEvent(eventch chan<- *apifabclient.ConnectionEvent, regch chan<- apifabclient.Registration, errch chan<- error) *RegisterConnectionEvent {
