...
func New(channelID string, context apifabclient.Context, connectionProvider api.ConnectionProvider, discoveryService apifabclient.DiscoveryService, opts ...options.Opt) *Dispatcher {
