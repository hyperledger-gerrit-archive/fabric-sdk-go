...
func TestNewPeerEndorserTLS(t *testing.T) {
	...
	conn, err := newPeerEndorser(url, mock_apiconfig.GoodCert, "", true, config, kap, false)
	if err != nil {
...
func TestNewPeerEndorserMutualTLSNoClientCerts(t *testing.T) {
	...
	_, err := newPeerEndorser(url, mock_apiconfig.GoodCert, "", true, config, kap, false)
	if err != nil {
		t.Fatalf("Peer conn should be constructed: %v", err)
	}
}
...
func TestNewPeerEndorserTLSBadPool(t *testing.T) {
	...
	_, err := newPeerEndorser(url, mock_apiconfig.BadCert, "", true, config, kap, false)
	if err == nil {
...
func TestNewPeerEndorserNoTLS(t *testing.T) {
	...
	conn, err := newPeerEndorser(url, nil, "", true, config, kap, false)
	if err != nil {
		t.Fatalf("Peer conn should be constructed")
	}
...
func TestNewPeerEndorserNonBlocking(t *testing.T) {
	...
	conn, err := newPeerEndorser(url, nil, "", false, config, kap, false)
	if err != nil {
		t.Fatalf("Peer conn should be constructed")
	}
...
func TestNewPeerEndorserBadParams(t *testing.T) {
	...
	url := ""
	_, err := newPeerEndorser(url, nil, "", true, config, kap, false)
	if err == nil {
