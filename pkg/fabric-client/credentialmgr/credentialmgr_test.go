...
func TestCredentialManager(t *testing.T) {
	...
	if err := checkSigningIdentity(credentialMgr, testUserName); err != context.ErrUserNotFound {
...
func checkSigningIdentity(credentialMgr context.CredentialManager, user string) error {
