...
const (
	...
	// NoMatchingCertificateAuthority is if entityMatchers are unable to find any matchingCertificateAuthority
	NoMatchingCertificateAuthority Code = 21

	// NoMatchingPeerConfig is if entityMatchers are unable to find any matchingPeer
	NoMatchingPeerConfig Code = 22

	// NoMatchingOrdererConfig is if entityMatchers are unable to find any matchingOrderer
	NoMatchingOrdererConfig Code = 23
)
...
var CodeName = map[int32]string{
	...
	21: "NO_MATCHING_CERTIFICATE_AUTHORITY",
	22: "NO_MATCHING_PEER",
	23: "NO_MATCHING_ORDERER",
}
