...
func GetChannel(client api.Client, channelID string) (api.Channel, error) {
...
func SendInstallCC(client api.Client, channel api.Channel, chainCodeID string, chainCodePath string, chainCodeVersion string, chaincodePackage []byte, targets []api.Peer, deployPath string) error {
...
func CreateAndJoinChannel(client api.Client, ordererUser api.User, orgUser api.User, channel api.Channel, channelConfig string) error {
