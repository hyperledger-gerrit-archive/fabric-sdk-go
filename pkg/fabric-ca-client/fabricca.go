...
func (fabricCAServices *FabricCA) Register(registrar idapi.User,
...
func (fabricCAServices *FabricCA) Revoke(registrar idapi.User,
...
func (fabricCAServices *FabricCA) createSigningIdentity(user idapi.
