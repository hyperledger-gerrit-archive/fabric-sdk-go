...
func TestMain(m *testing.M) {
	...
	cryptoSuiteProvider, _ = cryptosuite.GetSuiteByConfig(configImp)
...
func TestRevoke(t *testing.T) {
	...
	cryptoSuiteProvider, err := cryptosuite.GetSuiteByConfig(configImp)
	if err != nil {
...
func TestCreateValidBCCSPOptsForNewFabricClient(t *testing.T) {
	...
	newCryptosuiteProvider, err := cryptosuite.GetSuiteByConfig(mockConfig)
