...
func TestRegister(t *testing.T) {
	...
	_, err = fabricCAClient.Register(&ca.RegistrationRequest{})
	if err == nil {
	...
	secret, err := fabricCAClient.Register(&ca.RegistrationRequest{Name: "test", Affiliation: "test", Attributes: attributes})
	if err != nil {
...
func TestRevoke(t *testing.T) {
	...
	_, err = fabricCAClient.Revoke(&ca.RevocationRequest{})
	if err == nil {
