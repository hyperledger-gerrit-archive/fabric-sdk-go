...
// Source: github.com/hyperledger/fabric-sdk-go/pkg/common/providers/core (interfaces: Config,Providers)
...
func (m *MockConfig) GetByKey(arg0 string) (interface{}, error) {
