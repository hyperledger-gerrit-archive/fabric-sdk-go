...
// PeerResolverStrategy is the peer resolver type
type PeerResolverStrategy string

const (
	// BalancedStrategy is a peer resolver strategy that chooses peers based on a configured load balancer
	BalancedStrategy PeerResolverStrategy = "Balanced"
	...
	MinBlockHeightStrategy PeerResolverStrategy = "MinBlockHeight"
	...
	PreferOrgStrategy PeerResolverStrategy = "PreferOrg"
)
