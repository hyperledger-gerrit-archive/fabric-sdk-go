...
type EndpointConfig interface {
	...
	OrdererConfig(nameOrURL string) (*OrdererConfig, bool, error)
	PeersConfig(org string) ([]PeerConfig, error)
	PeerConfig(nameOrURL string) (*PeerConfig, bool, error)
	NetworkConfig() (*NetworkConfig, error)
	NetworkPeers() ([]NetworkPeer, error)
	ChannelConfig(name string) (*ChannelNetworkConfig, bool, error)
