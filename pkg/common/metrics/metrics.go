...
var (
	// SdkMetrics holds an instance of clientMetrics to be used by the SDK
	// At the time, only channel client has metrics configured. New metrics can be added in the future
	// the use of 'pprof' build tag is required to make use of metrics (along with the required configs).
	SdkMetrics      *ClientMetrics
