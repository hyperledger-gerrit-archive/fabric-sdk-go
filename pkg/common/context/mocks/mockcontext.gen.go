...
// IdentityProvider mocks base method
func (m *MockClient) IdentityProvider() identity.IdentityProvider {
	ret := m.ctrl.Call(m, "IdentityProvider")
	ret0, _ := ret[0].(identity.IdentityProvider)
	return ret0
}
...
// IdentityProvider indicates an expected call of IdentityProvider
func (mr *MockClientMockRecorder) IdentityProvider() *gomock.Call {
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "IdentityProvider", reflect.TypeOf((*MockClient)(nil).IdentityProvider))
}
