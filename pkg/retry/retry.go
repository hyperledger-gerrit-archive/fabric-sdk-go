...
// NewWithDefaults new retry Handler with default opts
func NewWithDefaults() Handler {
	return &impl{opts: DefaultOpts}
}

// NewWithAttempts new retry Handler with given attempts. Other opts are set to default.
func NewWithAttempts(attempts int) Handler {
	opts := DefaultOpts
