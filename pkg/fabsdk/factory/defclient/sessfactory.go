...
func (f *SessionClientFactory) CreateChannelClient(providers context.BaseProviders, session context.Session, channelID string, targetFilter fab.TargetFilter) (*channel.Client, error) {
