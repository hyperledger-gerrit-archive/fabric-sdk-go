...
func (f *SessionClientFactory) NewChannelClient(providers apisdk.Providers, session apisdk.SessionContext, channelID string, discoveryTargetFilter apifabclient.TargetFilter) (apitxn.ChannelClient, error) {
	...
	discoveryService = discovery.NewDiscoveryFilterService(discoveryService, discoveryTargetFilter)
