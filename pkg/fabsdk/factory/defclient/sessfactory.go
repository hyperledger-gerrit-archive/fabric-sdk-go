...
func (f *SessionClientFactory) CreateChannelClient(providers context.Providers, session context.SessionContext, channelID string, targetFilter fab.TargetFilter) (*channel.Client, error) {
