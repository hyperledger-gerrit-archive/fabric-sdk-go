...
func (f *OrgClientFactory) NewMSPClient(orgName string, config apiconfig.Config, cryptoProvider core.CryptoSuite) (fabca.FabricCAClient, error) {
...
func (f *OrgClientFactory) NewCredentialManager(orgName string, config apiconfig.Config, cryptoProvider core.CryptoSuite) (fab.CredentialManager, error) {
