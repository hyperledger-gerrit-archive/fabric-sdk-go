...
// MemberID returns the member identifier for this channel
func (cs *ChannelService) MemberID() (fab.ChannelMemberID, error) {
	return cs.fabricProvider.CreateChannelMemberID(cs.cfg)
}
