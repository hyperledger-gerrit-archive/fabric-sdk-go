...
// Deprecated. Use reateIdentityManager
...
// CreateIdentityManager returns a new identity manager initialized for the current instance of the SDK.
func (f *FabricProvider) CreateIdentityManager(orgID string) (identity.Manager, error) {
	return idmgmtclient.New(idmgmtclient.Context{
		MspID:       orgID,
		Config:      f.providerContext.Config(),
		CryptoSuite: f.providerContext.CryptoSuite(),
	})
}
