...
func populateReferenceFactoryOptions(options *Options) {
	...
	options.ProviderFactory = defprovider.NewDefaultProviderFactory()
	options.ContextFactory = defprovider.NewOrgClientFactory()
	options.SessionFactory = defprovider.NewSessionClientFactory()
	options.FabricSystemFactory = defprovider.NewFabricSystemFactory()
}
