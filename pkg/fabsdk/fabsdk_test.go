...
func TestNewDefaultSDK(t *testing.T) {
	...
	clt1, err := sdk.Client(FromName(sdkValidClientUser))
	if err != nil {
	...
	clt2, err := sdk.Client(FromName(sdkValidClientUser), WithOrg(sdkValidClientOrg2))
	if err != nil {
		t.Fatalf("Failed to create client: %s", err)
	}
...
func TestWithSessionPkg(t *testing.T) {
	...
	identity, err := sdk.newIdentity(sdkValidClientOrg1, FromName(sdkValidClientUser))
	if err != nil {
	...
	clt, err := sdk.Client(FromName(sdkValidClientUser))
	if err != nil {
...
func TestNewDefaultTwoValidSDK(t *testing.T) {
	...
	clt1, err := sdk1.Client(FromName(sdkValidClientUser))
	if err != nil {
		t.Fatalf("Failed to create client: %s", err)
	}
	...
	clt2, err := sdk2.Client(FromName(sdkValidClientUser))
	if err != nil {
		t.Fatalf("Failed to create client: %s", err)
	}
