...
func verifySDK(t *testing.T, sdk *FabricSDK) {
	...
	chCtx1 := sdk.ChannelContext(WithChannelIdentityUser(sdkValidClientUser), WithChannelIdentityOrgName(sdkValidClientOrg2), WithChannelID("mychannel"))
	chCtx2 := sdk.ChannelContext(WithChannelIdentityUser(sdkValidClientUser), WithChannelIdentityOrgName(sdkValidClientOrg2), WithChannelID("orgchannel"))
...
func TestNewDefaultTwoValidSDK(t *testing.T) {
	...
	cc1CtxC1 := sdk1.ChannelContext(WithChannelIdentityUser(sdkValidClientUser), WithChannelIdentityOrgName(sdkValidClientOrg1), WithChannelID("mychannel"))
	cc1CtxC2 := sdk1.ChannelContext(WithChannelIdentityUser(sdkValidClientUser), WithChannelIdentityOrgName(sdkValidClientOrg1), WithChannelID("orgchannel"))
	...
	// Get a common client context for the following tests
	cc2CtxC1 := sdk1.ChannelContext(WithChannelIdentityUser(sdkValidClientUser), WithChannelIdentityOrgName(sdkValidClientOrg2), WithChannelID("mychannel"))
	cc2CtxC2 := sdk1.ChannelContext(WithChannelIdentityUser(sdkValidClientUser), WithChannelIdentityOrgName(sdkValidClientOrg2), WithChannelID("orgchannel"))
