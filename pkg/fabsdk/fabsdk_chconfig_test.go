...
func verifySDK(t *testing.T, sdk *FabricSDK) {
	...
	ctx := sdk.Context(WithUser(sdkValidClientUser), WithOrgName(sdkValidClientOrg2))
	chCtx1 := ChannelContext(ctx, "mychannel")
	chCtx2 := ChannelContext(ctx, "orgchannel")
...
func TestNewDefaultTwoValidSDK(t *testing.T) {
	...
	ctx1 := sdk1.Context(WithUser(sdkValidClientUser), WithOrgName(sdkValidClientOrg1))
	cc1CtxC1 := ChannelContext(ctx1, "mychannel")
	cc1CtxC2 := ChannelContext(ctx1, "orgchannel")
	...
	// Get a common client context for the following tests
	ctx2 := sdk2.Context(WithUser(sdkValidClientUser), WithOrgName(sdkValidClientOrg2))
	cc2CtxC1 := ChannelContext(ctx2, "mychannel")
	cc2CtxC2 := ChannelContext(ctx2, "orgchannel")
