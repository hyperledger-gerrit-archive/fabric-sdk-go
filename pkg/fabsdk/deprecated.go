...
//
// Deprecated: Use NewClient instead.
func (sdk *FabricSDK) NewChannelMgmtClientWithOpts(userName string, opt *ChannelMgmtClientOpts) (resmgmt.ChannelMgmtClient, error) {
	o := []ContextOption{}
	if opt.OrgName != "" {
...
//
// Deprecated: Use NewClient instead.
func (sdk *FabricSDK) NewChannelMgmtClient(userName string, opts ...ContextOption) (resmgmt.ChannelMgmtClient, error) {
