...
func initSDK(sdk *FabricSDK, config core.Config, opts []Option) error {
	...
	identityManagerProvider, err := sdk.opts.MSP.CreateIdentityManagerProvider(config, cryptoSuite, stateStore)
	if err != nil {
...
// MSPContext returns context for MSP services
func (sdk *FabricSDK) MSPContext() contextApi.MSPProvider {

	mspProvider := func() (contextApi.MSP, error) {
		return &context.MSPContext{Providers: sdk.provider}, nil
	}
