...
func (sdk *FabricSDK) Context(options ...IdentityOption) contextApi.Client {
	...
	return &context.Client{Provider: sdk.provider, Identity: identity}
}

//NewChannelContext creates and returns channel context
func NewChannelContext(client contextApi.Client, channelID string) *context.ChannelClient {
	return context.NewChannelClient(client, channelID)
}
