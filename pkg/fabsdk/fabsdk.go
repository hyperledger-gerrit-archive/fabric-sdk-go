...
func WithConfigCryptoSuite(cryptoConfigs ...interface{}) Option {
	return func(opts *options) error {
		c, err := cryptosuite.BuildConfigCryptoFromOptions(cryptoConfigs...)
		if err != nil {
			return err
		}
...
func WithConfigIdentity(identityConfigs ...interface{}) Option {
	return func(opts *options) error {
		c, err := mspImpl.BuildConfigIdentityFromOptions(identityConfigs...)
		if err != nil {
			return err
		}
