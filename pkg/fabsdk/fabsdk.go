...
func NewSDK(options Options) (*FabricSDK, error) {
	...
	if sdk.LoggerFactory == nil {
		return nil, errors.New("LoggerFactory must be provided - see def/fabapi pkg")
	}
	if sdk.ProviderFactory == nil {
		return nil, errors.New("ProviderFactory must be provided - see def/fabapi pkg")
	}
	if sdk.ContextFactory == nil {
		return nil, errors.New("ContextFactory must be provided - see def/fabapi pkg")
	}
	if sdk.SessionFactory == nil {
		return nil, errors.New("SessionFactory must be provided - see def/fabapi pkg")
	}
