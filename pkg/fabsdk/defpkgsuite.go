...
func (ps *defPkgSuite) Core() (context.CoreProviderFactory, error) {
	return defcore.NewProviderFactory(), nil
}

func (ps *defPkgSuite) Service() (context.ServiceProviderFactory, error) {
	return defsvc.NewProviderFactory(), nil
}

func (ps *defPkgSuite) Context() (context.OrgClientFactory, error) {
	return defclient.NewOrgClientFactory(), nil
}

func (ps *defPkgSuite) Session() (SessionClientFactory, error) {
