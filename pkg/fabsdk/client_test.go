...
func TestNewGoodClientOpt(t *testing.T) {
	...
	_, err = sdk.Client(FromUserID(clientValidUser), goodClientOpt())
	if err != nil {
...
func TestNewBadClientOpt(t *testing.T) {
	...
	_, err = sdk.Client(FromUserID(clientValidUser), badClientOpt())
	if err == nil {
...
func TestClient(t *testing.T) {
	...
	_, err = sdk.Client(FromUserID(clientValidUser))
	if err != nil {
		t.Fatalf("Expected no error from Client, but got %v", err)
	}
}
...
func TestWithOrg(t *testing.T) {
	...
	_, err = sdk.Client(FromUserID("notarealuser"), WithOrg(clientValidExtraOrg))
	if err == nil {
		t.Fatal("Expected error from Client")
	}

	_, err = sdk.Client(FromUserID(clientValidExtraUser), WithOrg(clientValidExtraOrg))
	if err != nil {
		t.Fatalf("Expected no error from Client, but got %v", err)
	}
}
