...
func (_m *MockCoreProviderFactory) NewFabricProvider(_param0 apiconfig.Config, _param1 apicryptosuite.CryptoSuite, _param2 apifabclient.SigningManager) (apicore.FabricProvider, error) {
	ret := _m.ctrl.Call(_m, "NewFabricProvider", _param0, _param1, _param2)
	ret0, _ := ret[0].(apicore.FabricProvider)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (_mr *MockCoreProviderFactoryMockRecorder) NewFabricProvider(arg0, arg1, arg2 interface{}) *gomock.Call {
	return _mr.mock.ctrl.RecordCallWithMethodType(_mr.mock, "NewFabricProvider", reflect.TypeOf((*MockCoreProviderFactory)(nil).NewFabricProvider), arg0, arg1, arg2)
}
