...
func (m *MockCoreProviderFactory) CreateFabricProvider(arg0 context.Provider) (fab.FabricProvider, error) {
...
func (m *MockSessionClientFactory) CreateChannelClient(arg0 context.BaseProviders, arg1 context.Session, arg2 string, arg3 fab.TargetFilter) (*channel.Client, error) {
