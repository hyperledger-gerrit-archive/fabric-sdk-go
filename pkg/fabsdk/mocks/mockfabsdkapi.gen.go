...
// Source: github.com/hyperledger/fabric-sdk-go/pkg/fabsdk/api (interfaces: CoreProviderFactory,ServiceProviderFactory,OrgClientFactory,SessionClientFactory)
...
func (m *MockCoreProviderFactory) CreateFabricProvider(arg0 context.ProviderContext) (context.FabricProvider, error) {
...
func (m *MockSessionClientFactory) CreateChannelClient(arg0 context.Providers, arg1 context.SessionContext, arg2 string, arg3 fab.TargetFilter) (*channel.Client, error) {
