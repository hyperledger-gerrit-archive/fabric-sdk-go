...
func TestTLSCAConfig(t *testing.T) {
	...
	certConfig := urlutil.TLSConfig{Path: certFile}
	...
	badCertConfig := urlutil.TLSConfig{Path: "some random invalid path"}
	...
	keyConfig := urlutil.TLSConfig{Path: keyFile}
...
func TestTLSCAConfigFromPems(t *testing.T) {
	...
	certConfig := urlutil.TLSConfig{Pem: certPem}
	...
	badCertConfig := urlutil.TLSConfig{Pem: "some random invalid pem"}
	...
	keyConfig := urlutil.TLSConfig{Pem: keyPem}
