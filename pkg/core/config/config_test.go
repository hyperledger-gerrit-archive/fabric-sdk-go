...
func TestTLSCAConfig(t *testing.T) {
	...
	certConfig := certutil.TLSConfig{Path: certFile}
	...
	badCertConfig := certutil.TLSConfig{Path: "some random invalid path"}
	...
	keyConfig := certutil.TLSConfig{Path: keyFile}
...
func TestTLSCAConfigFromPems(t *testing.T) {
	...
	certConfig := certutil.TLSConfig{Pem: certPem}
	...
	badCertConfig := certutil.TLSConfig{Pem: "some random invalid pem"}
	...
	keyConfig := certutil.TLSConfig{Pem: keyPem}
