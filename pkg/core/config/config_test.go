...
func TestTLSCAConfig(t *testing.T) {
	...
	certConfig := cryptoutil.TLSConfig{Path: certFile}
	...
	badCertConfig := cryptoutil.TLSConfig{Path: "some random invalid path"}
	...
	keyConfig := cryptoutil.TLSConfig{Path: keyFile}
...
func TestTLSCAConfigFromPems(t *testing.T) {
	...
	certConfig := cryptoutil.TLSConfig{Pem: certPem}
	...
	badCertConfig := cryptoutil.TLSConfig{Pem: "some random invalid pem"}
	...
	keyConfig := cryptoutil.TLSConfig{Pem: keyPem}
