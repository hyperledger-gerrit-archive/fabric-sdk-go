...
func FromReader(in io.Reader, configType string, opts ...Option) core.ConfigBackendProvider {
...
func FromFile(name string, opts ...Option) core.ConfigBackendProvider {
	return func() (core.ConfigBackend, error) {
		backend, err := newBackend(opts...)
		if err != nil {
			return nil, err
...
func FromRaw(configBytes []byte, configType string, opts ...Option) core.ConfigBackendProvider {
