...
func hasLoggerFnPrefix(pkgPath string, fnName string) bool {
	const LOGGINGAPI_PATH = "github.com/hyperledger/fabric-sdk-go/pkg/core/logging/"
	const LOGGINGAPI_PKG = "api"
	const LOGGING_PATH = "github.com/hyperledger/fabric-sdk-go/pkg/common/"
	const LOGGING_PKG = "logging"
	const LOGBRIDGE_PATH = "github.com/hyperledger/fabric-sdk-go/internal/github.com/hyperledger/fabric-ca/sdkpatch/logbridge"
	const LOGBRIDGE_PKG = "logbridge"

	switch pkgPath {
	case LOGGINGAPI_PATH:
		return strings.HasPrefix(fnName, LOGGINGAPI_PKG)
	case LOGGING_PATH:
		return strings.HasPrefix(fnName, LOGGING_PKG)
	case LOGBRIDGE_PATH:
		return strings.HasPrefix(fnName, LOGBRIDGE_PKG)
	}
