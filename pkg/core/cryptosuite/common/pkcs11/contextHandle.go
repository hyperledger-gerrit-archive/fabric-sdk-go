...
// reLogin destorys pkcs11 context and tries to re-login and returns new session
...
func (handle *ContextHandle) isEmpty(session mPkcs11.SessionHandle) error {
