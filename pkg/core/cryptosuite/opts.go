...
// BuildConfigCryptoFromOptions will return an CryptoConfig instance pre-built with Optional interfaces
// provided in fabsdk's WithConfigCrypto(opts...) call
func BuildConfigCryptoFromOptions(opts ...interface{}) (core.CryptoSuiteConfig, error) {
