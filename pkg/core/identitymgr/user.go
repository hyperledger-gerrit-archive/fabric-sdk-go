...
func userIdentifier(userData persistence.UserData) persistence.UserIdentifier {
	return persistence.UserIdentifier{MspID: userData.MspID, Name: userData.Name}
}
...
// UserStore is responsible for persistence.UserData persistence
type UserStore interface {
	Store(persistence.UserData) error
	Load(persistence.UserIdentifier) (persistence.UserData, error)
}
