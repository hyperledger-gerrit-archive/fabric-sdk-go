...
func TestLevelledLoggingForCustomLogger(t *testing.T) {
	...
	logger := NewCustomLogger(moduleName, &SampleCustomLogger{customLogger: customLogger})
...
func (l *SampleCustomLogger) AddCustomLogger(customLogger apilogging.Logger) {
