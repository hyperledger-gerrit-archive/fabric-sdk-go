...
const (
	basicLevelOutputWithCallerInfoExpectedRegex = "\\[%s\\] .* UTC - logging.* -> %5.5s brown fox jumps over the lazy dog"
	basicLevelOutputExpectedRegex               = "\\[%s\\] .* UTC .*-> %5.5s brown fox jumps over the lazy dog"
