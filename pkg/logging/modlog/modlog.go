...
var moduleLevels = &decorator.ModuleLevels{}
...
func SetLevel(module string, level decorator.Level) {
	rwmutex.Lock()
...
func GetLevel(module string) decorator.Level {
	rwmutex.RLock()
...
func IsEnabledFor(module string, level decorator.Level) bool {
	rwmutex.RLock()
	defer rwmutex.RUnlock()
...
func ShowCallerInfo(module string, level decorator.Level) {
	rwmutex.Lock()
	defer rwmutex.Unlock()
...
func HideCallerInfo(module string, level decorator.Level) {
	rwmutex.Lock()
	defer rwmutex.Unlock()
...
func getLoggerOpts(module string, level decorator.Level) *loggerOpts {
	rwmutex.RLock()
	defer rwmutex.RUnlock()
	return &loggerOpts{
...
func (l *Log) Fatal(args ...interface{}) {
	opts := getLoggerOpts(l.module, decorator.CRITICAL)
	if l.loadCustomLogger() {
		l.customLogger.Fatal(args...)
		return
	}
	l.log(opts, decorator.CRITICAL, args...)
...
func (l *Log) Fatalf(format string, args ...interface{}) {
	...
	l.logf(opts, decorator.CRITICAL, format, args...)
...
func (l *Log) Fatalln(args ...interface{}) {
	...
	l.logln(opts, decorator.CRITICAL, args...)
...
func (l *Log) Debug(args ...interface{}) {
	opts := getLoggerOpts(l.module, decorator.DEBUG)
	...
	l.log(opts, decorator.DEBUG, args...)
}
...
func (l *Log) Debugf(format string, args ...interface{}) {
	...
	l.logf(opts, decorator.DEBUG, format, args...)
}
...
func (l *Log) Debugln(args ...interface{}) {
	...
	l.logln(opts, decorator.DEBUG, args...)
}

// Info calls go log.Output.
// Arguments are handled in the manner of fmt.Print.
func (l *Log) Info(args ...interface{}) {
	opts := getLoggerOpts(l.module, decorator.INFO)
	if !opts.levelEnabled {
		return
	}
	if l.loadCustomLogger() {
	...
	l.log(opts, decorator.INFO, args...)
}
...
func (l *Log) Infof(format string, args ...interface{}) {
	...
	l.logf(opts, decorator.INFO, format, args...)
}
...
func (l *Log) Infoln(args ...interface{}) {
	...
	l.logln(opts, decorator.INFO, args...)
}

// Warn calls go log.Output.
// Arguments are handled in the manner of fmt.Print.
func (l *Log) Warn(args ...interface{}) {
	opts := getLoggerOpts(l.module, decorator.WARNING)
	if !opts.levelEnabled {
		return
	}
	if l.loadCustomLogger() {
	...
	l.log(opts, decorator.WARNING, args...)
}
...
func (l *Log) Warnf(format string, args ...interface{}) {
	...
	l.logf(opts, decorator.WARNING, format, args...)
}
...
func (l *Log) Warnln(args ...interface{}) {
	...
	l.logln(opts, decorator.WARNING, args...)
}

// Error calls go log.Output.
// Arguments are handled in the manner of fmt.Print.
func (l *Log) Error(args ...interface{}) {
	opts := getLoggerOpts(l.module, decorator.ERROR)
	if !opts.levelEnabled {
		return
	}
	if l.loadCustomLogger() {
	...
	l.log(opts, decorator.ERROR, args...)
}
...
func (l *Log) Errorf(format string, args ...interface{}) {
	...
	l.logf(opts, decorator.ERROR, format, args...)
}
...
func (l *Log) Errorln(args ...interface{}) {
	...
	l.logln(opts, decorator.ERROR, args...)
}
...
func (l *Log) logf(opts *loggerOpts, level decorator.Level, format string, args ...interface{}) {
	//Format prefix to show function name and log level and to indicate that timezone used is UTC
	customPrefix := fmt.Sprintf(logLevelFormatter, l.getCallerInfo(opts), decorator.ParseString(level))
	l.deflogger.Output(2, customPrefix+fmt.Sprintf(format, args...))
}

func (l *Log) log(opts *loggerOpts, level decorator.Level, args ...interface{}) {
	//Format prefix to show function name and log level and to indicate that timezone used is UTC
	customPrefix := fmt.Sprintf(logLevelFormatter, l.getCallerInfo(opts), decorator.ParseString(level))
	l.deflogger.Output(2, customPrefix+fmt.Sprint(args...))
}

func (l *Log) logln(opts *loggerOpts, level decorator.Level, args ...interface{}) {
	//Format prefix to show function name and log level and to indicate that timezone used is UTC
	customPrefix := fmt.Sprintf(logLevelFormatter, l.getCallerInfo(opts), decorator.ParseString(level))
