...
func (p *Provider) GetLogger(module string) apilogging.Logger {
	...
	return &DefLogger{deflogger: newDefLogger, module: module}
}
...
//InitModuledLogger sets custom logger which will be used over deflogger.
//It is required to call this function before making any loggings.
func InitModuledLogger(l apilogging.LoggerProvider) {
...
func (l *DefLogger) loadCustomLogger() bool {
	l.once.Do(func() {
