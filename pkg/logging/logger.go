...
func SetLevel(module string, level Level) {
	modlog.SetLevel(module, decorator.Level(level))
}
...
func IsEnabledFor(module string, level Level) bool {
	return modlog.IsEnabledFor(module, decorator.Level(level))
}

// LogLevel returns the log level from a string representation.
func LogLevel(level string) (Level, error) {
	l, err := decorator.ParseLevel(level)
	return Level(l), err
}
...
func ParseString(level Level) string {
	return decorator.ParseString(decorator.Level(level))
}
