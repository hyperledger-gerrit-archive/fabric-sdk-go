...
var customLogger apilogging.Logger = &EmptyCustomLogger{}
...
func GetLogger(module string) (*Logger, error) {
	...
	return &Logger{defaultLogger: newLogger, module: module, customLogger: customLogger}, nil
}
...
func NewDefaultLogger(module string) *Logger {
	...
	logger.customLogger = &EmptyCustomLogger{}
	return logger
}

func SetCustomLogger(newCustomLogger apilogging.Logger) {
	if newCustomLogger != nil {
		customLogger = newCustomLogger
		return
	}
	customLogger = &EmptyCustomLogger{}
}
