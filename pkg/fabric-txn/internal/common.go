...
func CreateAndSendTransactionProposal(sender txnapi.TxnProposalSender, chainCodeID string, channelID string,
...
func CreateAndSendTransaction(sender txnapi.TxnSender, resps []*txnapi.TransactionProposalResponse) ([]*txnapi.TransactionResponse, error) {
