...
func CreateAndSendTransactionProposal(sender txnapi.ProposalSender, chainCodeID string, channelID string,
...
func CreateAndSendTransaction(sender txnapi.Sender, resps []*txnapi.TransactionProposalResponse) ([]*txnapi.TransactionResponse, error) {
