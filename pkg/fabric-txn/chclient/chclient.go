...
func (cc *ChannelClient) Query(request apitxn.Request, options ...apitxn.Option) ([]byte, error) {
	...
	response := cc.InvokeHandler(txnHandlerImpl.GetQueryHandler(), request, cc.addDefaultTimeout(apiconfig.Query, options...)...)
...
func (cc *ChannelClient) Execute(request apitxn.Request, options ...apitxn.Option) ([]byte, apitxn.TransactionID, error) {
	...
	response := cc.InvokeHandler(txnHandlerImpl.GetExecuteHandler(), request, cc.addDefaultTimeout(apiconfig.Execute, options...)...)
