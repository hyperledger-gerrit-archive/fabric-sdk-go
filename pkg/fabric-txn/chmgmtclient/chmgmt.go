...
//prepareSaveChannelOpts Reads chmgmt.SaveChannelOpts from chmgmt.Option array
func (cc *ChannelMgmtClient) prepareSaveChannelOpts(options ...chmgmt.Option) (chmgmt.SaveChannelOpts, error) {
	saveChannelOpts := chmgmt.SaveChannelOpts{}
