...
func NewMockDiscoveryProvider(err error) (*MockStaticDiscoveryProvider, error) {
	return &MockStaticDiscoveryProvider{Error: err}, nil
}
...
func (dp *MockStaticDiscoveryProvider) NewDiscoveryService(channel apifabclient.Channel) (apifabclient.DiscoveryService, error) {
	return &MockStaticDiscoveryService{Error: dp.Error}, nil
}
