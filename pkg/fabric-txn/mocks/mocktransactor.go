...
func (t *MockTransactor) CreateTransactionProposal(request fab.TransactionProposalRequest) (*fab.TransactionProposal, error) {
	tp, err := txn.NewProposal(t.Ctx, t.ChannelName, request)
	if err != nil {
