...
func (dp *MockSelectionProvider) NewSelectionService(ccPolicyService apifabclient.CCPolicyService) (apifabclient.SelectionService, error) {
	return &MockSelectionService{Error: dp.Error, Peers: dp.Peers}, nil
}

// GetEndorsersForChaincode mocks retrieving endorsing peers
func (ds *MockSelectionService) GetEndorsersForChaincode(channelID string, channelPeers []apifabclient.Peer,
