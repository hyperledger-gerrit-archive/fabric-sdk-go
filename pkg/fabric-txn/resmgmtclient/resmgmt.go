...
func (rc *ResourceMgmtClient) InstallCCWithOpts(req resmgmt.InstallCCRequest, opts resmgmt.InstallCCOpts) ([]resmgmt.InstallCCResponse, error) {
	...
	icr := fab.InstallChaincodeRequest{Name: req.Name, Path: req.Path, Version: req.Version, GoPath: req.GoPath, Package: opts.Package, Targets: peer.PeersToTxnProcessors(newTargets)}
