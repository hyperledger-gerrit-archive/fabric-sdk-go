...
func (rc *ResourceMgmtClient) InstantiateCC(channelID string, req resmgmt.InstantiateCCRequest) error {
	...
	if err := checkRequiredCCProposalParams(req); err != nil {
		return err
	}
...
func (rc *ResourceMgmtClient) InstantiateCCWithOpts(channelID string, req resmgmt.InstantiateCCRequest, opts resmgmt.InstantiateCCOpts) error {
	...
	return rc.instantiateOrUpgradeCCWithOpts("instantiate", channelID, req, opts)
...
func (rc *ResourceMgmtClient) UpgradeCC(channelID string, req resmgmt.UpgradeCCRequest) error {
	...
	if err := checkRequiredCCProposalParams(resmgmt.InstantiateCCRequest(req)); err != nil {
		return err
	}
...
func (rc *ResourceMgmtClient) UpgradeCCWithOpts(channelID string, req resmgmt.UpgradeCCRequest, opts resmgmt.UpgradeCCOpts) error {
	...
	return rc.instantiateOrUpgradeCCWithOpts("upgrade", channelID, resmgmt.InstantiateCCRequest(req), resmgmt.InstantiateCCOpts(opts))

}

// InstantiateCCWithOpts instantiates chaincode with custom options
func (rc *ResourceMgmtClient) instantiateOrUpgradeCCWithOpts(fn string, channelID string, req resmgmt.InstantiateCCRequest, opts resmgmt.InstantiateCCOpts) error {
	...
	default:
		return errors.Errorf("chaincode proposal type %s not supported", fn)
	}
...
func checkRequiredCCProposalParams(req resmgmt.InstantiateCCRequest) error {
	if req.Name == "" || req.Version == "" || req.Path == "" {
		return errors.New("Chaincode name, version and path are required")
	}
	return nil
}
