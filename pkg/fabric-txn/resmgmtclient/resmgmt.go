...
func WithDefaultTargetFilter(filter TargetFilter) Option {
...
func (rc *ResourceMgmtClient) JoinChannel(channelID string, options ...RequestOption) error {
...
func (rc *ResourceMgmtClient) InstallCC(req InstallCCRequest, options ...RequestOption) ([]InstallCCResponse, error) {
...
func (rc *ResourceMgmtClient) InstantiateCC(channelID string, req InstantiateCCRequest, options ...RequestOption) error {
...
func (rc *ResourceMgmtClient) UpgradeCC(channelID string, req UpgradeCCRequest, options ...RequestOption) error {
...
func (rc *ResourceMgmtClient) sendCCProposal(ccProposalType channel.ChaincodeProposalType, channelID string, req InstantiateCCRequest, options ...RequestOption) error {
...
func (rc *ResourceMgmtClient) prepareResmgmtOpts(options ...RequestOption) (Opts, error) {
	resmgmtOpts := Opts{}
...
func (rc *ResourceMgmtClient) SaveChannel(req SaveChannelRequest, options ...RequestOption) error {
...
func (rc *ResourceMgmtClient) prepareSaveChannelOpts(options ...RequestOption) (Opts, error) {
