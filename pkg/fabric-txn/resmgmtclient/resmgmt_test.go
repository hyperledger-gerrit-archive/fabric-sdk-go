...
func TestIsChaincodeInstalled(t *testing.T) {
	...
	req := resmgmt.InstallCCRequest{ID: "name", Version: "version", Path: "path"}
	...
	req = resmgmt.InstallCCRequest{ID: "ID", Version: "v0", Path: "path"}
...
func TestInstallCCWithOpts(t *testing.T) {
	...
	req = resmgmt.InstallCCRequest{ID: "error", Version: "v0", Path: "path"}
	...
	req = resmgmt.InstallCCRequest{ID: "errorInResponse", Version: "v0", Path: "path"}
	responses, err = rc.InstallCCWithOpts(req, resmgmt.InstallCCOpts{Targets: peers})
	if err != nil {
		t.Fatal(err)
	}
...
func TestInstallCCRequiredParameters(t *testing.T) {
	...
	req = resmgmt.InstallCCRequest{ID: "", Version: "v0", Path: "path"}
	_, err = rc.InstallCC(req)
	if err == nil {
	...
	req = resmgmt.InstallCCRequest{ID: "ID", Version: "", Path: "path"}
	_, err = rc.InstallCC(req)
	if err == nil {
	...
	req = resmgmt.InstallCCRequest{ID: "ID", Version: "v0", Path: ""}
	_, err = rc.InstallCC(req)
	if err == nil {
