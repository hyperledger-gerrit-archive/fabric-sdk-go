...
func TestJoinChannelFail(t *testing.T) {
	...
	rc := setupResMgmtClient(ctx, nil, t, nil)
...
func TestWithFilterOption(t *testing.T) {
	...
	rc := setupResMgmtClient(ctx, nil, t, WithTargetFilter(targetFilter))
	if rc == nil {
...
func TestJoinChannelDiscoveryError(t *testing.T) {
	...
	rc := setupResMgmtClient(ctx, errors.New("Test Error"), t, nil)
...
func setupDefaultResMgmtClient(t *testing.T) *ResourceMgmtClient {
	...
	return setupResMgmtClient(ctx, nil, t, nil)
}
