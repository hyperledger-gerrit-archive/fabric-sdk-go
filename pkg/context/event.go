...
// The EventHubExt interface allows extensions of the SDK to add functionality to EventHubConnection overloads.
...
// ChainCodeCBE ...
/**
 * The ChainCodeCBE is used internal to the EventHubConnection to hold chaincode
