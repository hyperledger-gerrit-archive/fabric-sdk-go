...
func (c *ChannelClient) Providers() context.Client {
	return c
}

//DiscoveryService returns core discovery service
func (c *ChannelClient) DiscoveryService() fab.DiscoveryService {
	return c.discovery
}

//SelectionService returns selection service
func (c *ChannelClient) SelectionService() fab.SelectionService {
	return c.selection
}

//ChannelService returns channel service
func (c *ChannelClient) ChannelService() fab.ChannelService {
...
func NewChannelClient(client context.Client, channelID string) *ChannelClient {
