...
// Source: github.com/hyperledger/fabric-sdk-go/pkg/context (interfaces: ProposalProcessor,FabricCAClient,CoreProviders,SvcProviders,Providers,CoreProviderFactory,ServiceProviderFactory,OrgClientFactory)
...
import (
	...
	apiconfig "github.com/hyperledger/fabric-sdk-go/pkg/context/apiconfig"
	apicryptosuite "github.com/hyperledger/fabric-sdk-go/pkg/context/apicryptosuite"
)
...
func (m *MockProposalProcessor) ProcessTransactionProposal(arg0 context.ProcessProposalRequest) (*context.TransactionProposalResponse, error) {
	ret := m.ctrl.Call(m, "ProcessTransactionProposal", arg0)
	ret0, _ := ret[0].(*context.TransactionProposalResponse)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockFabricCAClient) Reenroll(arg0 context.User) (apicryptosuite.Key, []byte, error) {
...
func (m *MockFabricCAClient) Register(arg0 context.User, arg1 *context.RegistrationRequest) (string, error) {
...
func (m *MockFabricCAClient) Revoke(arg0 context.User, arg1 *context.RevocationRequest) (*api.RevocationResponse, error) {
...
func (m *MockCoreProviders) SigningManager() context.SigningManager {
	ret := m.ctrl.Call(m, "SigningManager")
	ret0, _ := ret[0].(context.SigningManager)
	return ret0
}
...
func (m *MockCoreProviders) StateStore() context.KVStore {
	ret := m.ctrl.Call(m, "StateStore")
	ret0, _ := ret[0].(context.KVStore)
	return ret0
}
...
func (m *MockSvcProviders) ChannelProvider() context.ChannelProvider {
	ret := m.ctrl.Call(m, "ChannelProvider")
	ret0, _ := ret[0].(context.ChannelProvider)
	return ret0
}
...
func (m *MockSvcProviders) DiscoveryProvider() context.DiscoveryProvider {
	ret := m.ctrl.Call(m, "DiscoveryProvider")
	ret0, _ := ret[0].(context.DiscoveryProvider)
	return ret0
}
...
func (m *MockSvcProviders) SelectionProvider() context.SelectionProvider {
	ret := m.ctrl.Call(m, "SelectionProvider")
	ret0, _ := ret[0].(context.SelectionProvider)
	return ret0
}
...
// ChannelProvider mocks base method
func (m *MockProviders) ChannelProvider() context.ChannelProvider {
	ret := m.ctrl.Call(m, "ChannelProvider")
	ret0, _ := ret[0].(context.ChannelProvider)
	return ret0
}
...
// DiscoveryProvider mocks base method
func (m *MockProviders) DiscoveryProvider() context.DiscoveryProvider {
	ret := m.ctrl.Call(m, "DiscoveryProvider")
	ret0, _ := ret[0].(context.DiscoveryProvider)
	return ret0
}
...
// SelectionProvider mocks base method
func (m *MockProviders) SelectionProvider() context.SelectionProvider {
	ret := m.ctrl.Call(m, "SelectionProvider")
	ret0, _ := ret[0].(context.SelectionProvider)
	return ret0
}
...
// SigningManager mocks base method
func (m *MockProviders) SigningManager() context.SigningManager {
	ret := m.ctrl.Call(m, "SigningManager")
	ret0, _ := ret[0].(context.SigningManager)
	return ret0
}
...
// StateStore mocks base method
func (m *MockProviders) StateStore() context.KVStore {
	ret := m.ctrl.Call(m, "StateStore")
	ret0, _ := ret[0].(context.KVStore)
	return ret0
}
...
func (m *MockCoreProviderFactory) NewFabricProvider(arg0 context.ProviderContext) (context.FabricProvider, error) {
...
func (m *MockCoreProviderFactory) NewSigningManager(arg0 apicryptosuite.CryptoSuite, arg1 apiconfig.Config) (context.SigningManager, error) {
...
func (m *MockCoreProviderFactory) NewStateStoreProvider(arg0 apiconfig.Config) (context.KVStore, error) {
...
func (m *MockServiceProviderFactory) NewDiscoveryProvider(arg0 apiconfig.Config) (context.DiscoveryProvider, error) {
...
func (m *MockServiceProviderFactory) NewSelectionProvider(arg0 apiconfig.Config) (context.SelectionProvider, error) {
...
func (m *MockOrgClientFactory) NewCredentialManager(arg0 string, arg1 apiconfig.Config, arg2 apicryptosuite.CryptoSuite) (context.CredentialManager, error) {
	ret := m.ctrl.Call(m, "NewCredentialManager", arg0, arg1, arg2)
	ret0, _ := ret[0].(context.CredentialManager)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
