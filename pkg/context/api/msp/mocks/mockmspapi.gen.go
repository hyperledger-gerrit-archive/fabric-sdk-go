...
func (m *MockIdentityManager) GetIdentity(arg0 string) (msp.Identity, error) {
...
func (mr *MockIdentityManagerMockRecorder) GetIdentity(arg0 interface{}) *gomock.Call {
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetIdentity", reflect.TypeOf((*MockIdentityManager)(nil).GetIdentity), arg0)
}
