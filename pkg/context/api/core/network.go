...
import "github.com/hyperledger/fabric-sdk-go/pkg/core/config/certutil"
...
type OrganizationConfig struct {
	...
	AdminPrivateKey        certutil.TLSConfig
	SignedCert             certutil.TLSConfig
}
