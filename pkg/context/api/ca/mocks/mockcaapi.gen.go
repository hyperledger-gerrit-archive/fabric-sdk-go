...
// Source: github.com/hyperledger/fabric-sdk-go/pkg/context/api/ca (interfaces: Client,Providers)
...
func (m *MockClient) Reenroll(arg0 string) error {
...
func (m *MockClient) Register(arg0 *ca.RegistrationRequest) (string, error) {
...
func (m *MockClient) Revoke(arg0 *ca.RevocationRequest) (*ca.RevocationResponse, error) {
	ret := m.ctrl.Call(m, "Revoke", arg0)
	ret0, _ := ret[0].(*ca.RevocationResponse)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
