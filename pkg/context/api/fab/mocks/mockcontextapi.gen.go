...
func (m *MockFabricCAClient) Reenroll(arg0 context.User) (core.Key, []byte, error) {
...
func (m *MockFabricCAClient) Register(arg0 context.User, arg1 *fab.RegistrationRequest) (string, error) {
...
func (m *MockFabricCAClient) Revoke(arg0 context.User, arg1 *fab.RevocationRequest) (*api.RevocationResponse, error) {
