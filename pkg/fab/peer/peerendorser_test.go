...
func TestExtractChaincodeNameNotFoundError(t *testing.T) {
	...
	err = grpcstatus.New(grpcCodes.Unknown, "Chaincode status Code: (500) UNKNOWN. Description: make sure the chaincode uq7q9y7lu7 has been successfully instantiated and try again: getccdata mychannel/uq7q9y7lu7 responded with error: could not find chaincode with name 'uq7q9y7lu7'")
...
func TestChaincodeStatusFromResponse(t *testing.T) {
	...
	response = &pb.ProposalResponse{
		Response: &pb.Response{Status: 500, Payload: []byte("Unknown Description"), Message: "Chaincode status Code: (500) UNKNOWN. Description: make sure the chaincode uq7q9y7lu7 has been successfully instantiated and try again: getccdata mychannel/uq7q9y7lu7 responded with error: could not find chaincode with name 'uq7q9y7lu7'"},
	}
	err = extractChaincodeErrorFromResponse(response)
	s, ok = status.FromError(err)
	assert.True(t, ok)
	assert.Equal(t, "Chaincode status Code: (500) UNKNOWN. Description: make sure the chaincode uq7q9y7lu7 has been successfully instantiated and try again: getccdata mychannel/uq7q9y7lu7 responded with error: could not find chaincode with name 'uq7q9y7lu7'", s.Message)
