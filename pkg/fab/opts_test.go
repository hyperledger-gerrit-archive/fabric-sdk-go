...
var (
	...
	m6  = &MockPeersConfig{}
	m7  = &MockPeerConfig{}
	m8  = &MockPeerConfigByURL{}
	m9  = &MockNetworkConfig{}
	m10 = &MockNetworkPeers{}
	m11 = &MockChannelConfig{}
	m12 = &MockChannelPeers{}
	m13 = &MockChannelOrderers{}
	m14 = &MockTLSCACertPool{}
	m15 = &mockEventServiceType{}
	m16 = &MockTLSClientCerts{}
	m17 = &MockCryptoConfigPath{}
)

func TestCreateCustomFullEndpointConfig(t *testing.T) {
	// try to build with the overall interface
	endpointConfigOption, err := BuildConfigEndpointFromOptions(m0)
	if err != nil {
...
func TestCreateCustomEndpointConfig(t *testing.T) {
	...
	endpointConfigOption, err := BuildConfigEndpointFromOptions(m1, m2, m3, m4, m5, m6, m7, m8, m9, m10, m11)
	if err != nil {
		t.Fatalf("BuildConfigEndpointFromOptions returned unexpected error %s", err)
	}
...
func TestCreateCustomEndpointConfigRemainingFunctions(t *testing.T) {
	...
	endpointConfigOption, err := BuildConfigEndpointFromOptions(m12, m13, m14, m15, m16, m17)
	if err != nil {
		t.Fatalf("BuildConfigEndpointFromOptions returned unexpected error %s", err)
	}
	var eco *EndpointConfigOptions
...
func TestCreateCustomEndpoitConfigWithSomeDefaultFunctionsRemainingFunctions(t *testing.T) {
	...
	endpointConfigOption, err := BuildConfigEndpointFromOptions(m8, m9, m10, m11, m12, m13, m14, m15, m16, m17)
	if err != nil {
		t.Fatalf("BuildConfigEndpointFromOptions returned unexpected error %s", err)
	}
...
func (M *MockPeerConfig) PeerConfig(org string, name string) (*fab.PeerConfig, error) {
	return &fab.PeerConfig{URL: "p.com", EventURL: "event.p.com", GRPCOptions: nil, TLSCACerts: endpoint.TLSConfig{Path: "", Pem: ""}}, nil
}

type MockPeerConfigByURL struct{}

func (M *MockPeerConfigByURL) PeerConfigByURL(url string) (*fab.PeerConfig, error) {
	return &fab.PeerConfig{URL: "p.by.url.com", EventURL: "event.p.by.url.com", GRPCOptions: nil, TLSCACerts: endpoint.TLSConfig{Path: "", Pem: ""}}, nil
}
