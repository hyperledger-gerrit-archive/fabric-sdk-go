...
// NewIdentityManager Constructor for an identity manager.
// @param {string} orgName - organisation id
// @returns {IdentityManager} new credential manager
func NewIdentityManager(orgName string, config core.Config, cryptoProvider core.CryptoSuite) (fab.IdentityManager, error) {
