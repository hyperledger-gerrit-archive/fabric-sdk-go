...
// // TestCreateNewIdentityManagerCAConfigMissingFailure will test newFabricCA Client creation with with CAConfig
...
// // TestCreateNewIdentityManagerCertFilesMissingFailure will test newFabricCA Client creation with missing CA Cert files
...
// // TestCreateNewIdentityManagerCertFileErrorFailure will test newFabricCA Client creation with missing CA Cert files, additional scenario
...
// // TestCreateNewIdentityManagerKeyFileErrorFailure will test newFabricCA Client creation with missing CA Cert files and missing key
