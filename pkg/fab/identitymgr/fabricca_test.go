...
// // TestCreateNewCAConfigMissingFailure will test newFabricCA Client creation with with CAConfig
// func TestCreateNewCAConfigMissingFailure(t *testing.T) {
...
// // TestCreateNewCertFilesMissingFailure will test newFabricCA Client creation with missing CA Cert files
// func TestCreateNewCertFilesMissingFailure(t *testing.T) {
// 	mockCtrl := gomock.NewController(t)
// 	defer mockCtrl.Finish()
// 	mockConfig := mock_core.NewMockConfig(mockCtrl)
...
// // TestCreateNewCertFileErrorFailure will test newFabricCA Client creation with missing CA Cert files, additional scenario
// func TestCreateNewCertFileErrorFailure(t *testing.T) {
// 	mockCtrl := gomock.NewController(t)
// 	defer mockCtrl.Finish()
// 	mockConfig := mock_core.NewMockConfig(mockCtrl)
// 	mockConfig.EXPECT().CAConfig(org1).Return(&config.CAConfig{}, nil).AnyTimes()
...
// // TestCreateNewKeyFileErrorFailure will test newFabricCA Client creation with missing CA Cert files and missing key
// func TestCreateNewKeyFileErrorFailure(t *testing.T) {
// 	mockCtrl := gomock.NewController(t)
// 	defer mockCtrl.Finish()
// 	mockConfig := mock_core.NewMockConfig(mockCtrl)
// 	mockConfig.EXPECT().CAConfig(org1).Return(&config.CAConfig{}, nil).AnyTimes()
