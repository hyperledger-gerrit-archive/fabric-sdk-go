...
// OutputChannelCreateTx creates a Fabric transaction for creating a channel
func OutputChannelCreateTx(conf, baseProfile *genesisconfig.Profile, channelID string) ([]byte, error) {
