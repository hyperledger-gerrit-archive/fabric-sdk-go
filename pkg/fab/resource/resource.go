...
// QueryConfigBlockFromOrderer fetches the current configuration block for the specified channel
// from the given orderer
func (c *Resource) QueryConfigBlockFromOrderer(channelName string, orderer fab.Orderer) (*common.ConfigEnvelope, error) {
