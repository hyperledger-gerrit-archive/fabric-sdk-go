...
func TestCapabilities(t *testing.T) {
	capability1 := V1_1Capability
	capability2 := V1_2Capability
	...
	assert.Truef(t, chConfig.HasCapability(ChannelGroupKey, capability1), "expecting channel capability [%s]", capability1)
	assert.Truef(t, chConfig.HasCapability(OrdererGroupKey, capability1), "expecting orderer capability [%s]", capability1)
	assert.Truef(t, chConfig.HasCapability(ApplicationGroupKey, capability2), "expecting application capability [%s]", capability2)
	assert.Truef(t, chConfig.HasCapability(ApplicationGroupKey, capability3), "expecting application capability [%s]", capability3)
	assert.Falsef(t, chConfig.HasCapability(ApplicationGroupKey, capability4), "not expecting application capability [%s]", capability4)
}
