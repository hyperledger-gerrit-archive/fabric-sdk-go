...
func (c *EndpointConfig) loadDefaultChannel() {
	...
	if ok {
		...
		c.defaultChannel = &fab.ChannelEndpointConfig{Policies: defaultChannelPolicies}
	}
}
...
func (c *EndpointConfig) loadNetworkConfig(configEntity *endpointConfigEntity) error {
	...
	if ok {
		...
		networkConfig.Channels[defaultEntity] = fab.ChannelEndpointConfig{Policies: defaultChannelPolicies}
	}
