...
func IsEndpointConfigFullyOverridden(c *EndpointConfigOptions) bool {
	return !anyNil(
		c.timeout, c.mspID, c.peerMSPID, c.orderersConfig, c.ordererConfig, c.peersConfig, c.peerConfig, c.networkConfig, c.networkPeers,
		c.channelPeers, c.channelOrderers, c.tlsCACertPool, c.eventServiceType, c.tlsClientCerts, c.cryptoConfigPath)
}
