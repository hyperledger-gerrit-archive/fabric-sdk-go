...
// TODO refactor this function to remove meta-linter error
func setEndpointConfigWithOptionInterface(c *EndpointConfigOptions, o interface{}) error { //nolint
	var isSet bool
	if c.timeout == nil {
...
// TODO refactor this function to remove meta-linter error
func UpdateMissingOptsWithDefaultConfig(c *EndpointConfigOptions, d fab.EndpointConfig) fab.EndpointConfig { //nolint
	if c.timeout == nil {
		c.timeout = d
	}
	if c.mspID == nil {
