...
// TransactionID returns the transaction's identifier.
func (tid *TransactionHeader) TransactionID() fab.TransactionID {
	return fab.TransactionID(tid.id)
}
