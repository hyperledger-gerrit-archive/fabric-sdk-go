...
// CloseIfIdle closes the connection to the event server only if there are
// no any outstanding regsitrations
// true is returned if the client was closed; false otherwise
