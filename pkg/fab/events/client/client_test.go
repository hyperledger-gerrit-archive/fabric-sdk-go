...
type ClientProvider func(channelID string, context context.BaseContext, connectionProvider api.ConnectionProvider, discoveryService fab.DiscoveryService, opts []options.Opt) (*Client, error)

var clientProvider = func(channelID string, context context.BaseContext, connectionProvider api.ConnectionProvider, discoveryService fab.DiscoveryService, opts []options.Opt) (*Client, error) {
...
var failAfterConnectClientProvider = func(channelID string, context context.BaseContext, connectionProvider api.ConnectionProvider, discoveryService fab.DiscoveryService, opts []options.Opt) (*Client, error) {
	return newClient(channelID, context, connectionProvider, discoveryService, opts, true,
		func() error {
...
var filteredClientProvider = func(channelID string, context context.BaseContext, connectionProvider api.ConnectionProvider, discoveryService fab.DiscoveryService, opts []options.Opt) (*Client, error) {
...
func newClient(channelID string, context context.BaseContext, connectionProvider api.ConnectionProvider, discoveryService fab.DiscoveryService, opts []options.Opt, permitBlockEvents bool, afterConnect handler, beforeReconnect handler) (*Client, error) {
	client := New(
		permitBlockEvents,
		dispatcher.New(
			context, channelID,
...
func newClientWithMockConn(channelID string, context context.BaseContext, clientProvider ClientProvider, discoveryService fab.DiscoveryService, connOpts ...mockconn.Opt) (*Client, mockconn.Connection, error) {
...
func newClientWithMockConnAndOpts(channelID string, context context.BaseContext, connectionProvider api.ConnectionProvider, clientProvider ClientProvider, discoveryService fab.DiscoveryService, opts []options.Opt, connOpts ...mockconn.Opt) (*Client, mockconn.Connection, error) {
