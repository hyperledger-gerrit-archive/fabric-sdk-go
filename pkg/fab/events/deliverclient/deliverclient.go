...
func New(context fabcontext.Context, channelID string, discoveryService fab.DiscoveryService, opts ...options.Opt) (*Client, error) {
	return newClient(context, channelID, deliverProvider, discoveryService, true, opts...)
}

// NewFiltered returns a new deliver filtered event client
func NewFiltered(context fabcontext.Context, channelID string, discoveryService fab.DiscoveryService, opts ...options.Opt) (*Client, error) {
	return newClient(context, channelID, deliverFilteredProvider, discoveryService, false, opts...)
}

func newClient(context fabcontext.Context, channelID string, connProvider api.ConnectionProvider, discoveryService fab.DiscoveryService, permitBlockEvents bool, opts ...options.Opt) (*Client, error) {
	if channelID == "" {
