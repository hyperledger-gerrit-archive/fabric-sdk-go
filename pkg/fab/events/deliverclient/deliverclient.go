...
var deliverProvider = func(channelID string, context fabcontext.BaseContext, peer fab.Peer) (api.Connection, error) {
...
var deliverFilteredProvider = func(channelID string, context fabcontext.BaseContext, peer fab.Peer) (api.Connection, error) {
...
func New(context fabcontext.BaseContext, channelID string, discoveryService fab.DiscoveryService, opts ...options.Opt) (*Client, error) {
	if channelID == "" {
