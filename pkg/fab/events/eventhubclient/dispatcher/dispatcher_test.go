	...
	dispatcher := New(
		...
		clientmocks.NewProviderFactory().Provider(
			ehmocks.NewConnection(
				clientmocks.WithLedger(ehmocks.NewMockLedger(ehmocks.BlockEventFactory)),
			),
		),
...
func TestBlockEvents(t *testing.T) {
	channelID := "testchannel"
	ledger := ehmocks.NewMockLedger(ehmocks.BlockEventFactory)
	dispatcher := New(
		newMockContext(), channelID,
		clientmocks.NewProviderFactory().Provider(
			ehmocks.NewConnection(
...
func TestFilteredBlockEvents(t *testing.T) {
	channelID := "testchannel"
	ledger := ehmocks.NewMockLedger(ehmocks.FilteredBlockEventFactory)
	dispatcher := New(
		newMockContext(), channelID,
		clientmocks.NewProviderFactory().Provider(
			ehmocks.NewConnection(
