...
func TestEventServiceConfig(t *testing.T) {
	...
	customBackend.KeyValueMap["client.eventService.peerResolverStrategy"] = "Balanced"
	customBackend.KeyValueMap["client.eventService.peerBalancer"] = "RoundRobin"
	...
	assert.Equalf(t, fab.BalancedStrategy, eventServiceConfig.PeerResolverStrategy(), "invalid value for peerResolverStrategy")
	assert.Equalf(t, fab.RoundRobin, eventServiceConfig.PeerBalancer(), "invalid value for peerBalancer")
}
