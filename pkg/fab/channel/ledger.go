...
func NewLedger(ctx context.BaseContext, chName string) (*Ledger, error) {
	l := Ledger{
		ctx:    ctx,
		chName: chName,
	}
...
func queryChaincode(ctx context.BaseContext, channelID string, request fab.ChaincodeInvokeRequest, targets []fab.ProposalProcessor) ([]*fab.TransactionProposalResponse, error) {
