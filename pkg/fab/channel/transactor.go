...
func NewTransactor(ctx context.BaseContext, cfg fab.ChannelCfg) (*Transactor, error) {
...
func orderersFromChannelCfg(ctx context.BaseContext, cfg fab.ChannelCfg) ([]fab.Orderer, error) {
	orderers := []fab.Orderer{}
...
func orderersByTarget(ctx context.BaseContext) (map[string]core.OrdererConfig, error) {
