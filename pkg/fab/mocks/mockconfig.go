...
type MockEventServiceConfig struct {
	ResolverStrategy      fab.PeerResolverStrategy
	Balancer              fab.BalancerType
	LagThreshold          int
...
func (c *MockEventServiceConfig) PeerResolverStrategy() fab.PeerResolverStrategy {
	return c.ResolverStrategy
}

// PeerBalancer is the balancer to use when choosing a peer to connect to
func (c *MockEventServiceConfig) PeerBalancer() fab.BalancerType {
	return c.Balancer
}
