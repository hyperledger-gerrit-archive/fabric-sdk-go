...
// QueryConfigBlockFromOrderer not implemented
func (c *MockResource) QueryConfigBlockFromOrderer(channelName string, orderer fab.Orderer) (*common.ConfigEnvelope, error) {
	return nil, nil
}
